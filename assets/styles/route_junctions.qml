...
<qgis version="2.18.22" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{a5bb4873-54e4-4ff9-ae1a-ce87640a2334}">
      <rule filter=" &quot;dp_type&quot; = 0" key="{a5aede42-5333-42b5-9294-d8b987a0375a}" symbol="0" label="no_junction"/>
      <rule filter=" &quot;dp_type&quot; = 1" key="{db8bdb82-60ed-4ad4-ba8e-ca2fa266aac7}" symbol="1" label="straight_on"/>
      <rule filter=" &quot;dp_type&quot; = 2" key="{c2ed386c-b71e-4d52-b9e7-80b675d050cf}" symbol="2" label="turn_not_at_junction"/>
      <rule filter=" &quot;dp_type&quot; = 3" key="{4e4908af-226a-40eb-be19-269d654e783a}" symbol="3" label="t-junction"/>
      <rule filter=" &quot;dp_type&quot; = 4" key="{79355c83-e446-4cfb-aab3-e2e4c1f3de2f}" symbol="4" label="junction"/>
      <rule filter=" &quot;dp_type&quot; =  -1 " key="{48bde616-afec-4434-8055-a4f5a4eb9212}" symbol="5" label="other"/>
    </rules>
    <symbols>
      ...
      <symbol alpha="1" clip_to_extent="1" type="marker" name="3">
        <layer pass="0" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="255,182,113,255"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="name" v="circle"/>
          <prop k="offset" v="0,0"/>
  ...
  <aliases>
    ...
    <alias field="dp_type" index="6" name=""/>
  </aliases>
