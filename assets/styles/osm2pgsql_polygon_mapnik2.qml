...
<qgis version="2.18.22" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
    ...
    <rules key="{4460c20d-65ab-4c6f-99cd-f718bcb014e0}">
      <rule scalemaxdenom="40000" key="{914677b7-4df0-490e-b3e0-e95a1f780e71}" scalemindenom="1" label="Zoom 1-40K">
        <rule filter="&quot;building&quot; IS NOT NULL" key="{4e5004ea-09f4-4ef1-9bd5-41045cbd632f}" label="Building">
          <rule filter="&quot;building&quot; IN ( 'church','cathedral') OR  &quot;amenity&quot; IN ('place_of_worship')" key="{78e8abfa-437a-43ad-af60-a044180080a6}" symbol="0" label="Church"/>
          <rule filter="&quot;building&quot; NOT IN ( 'church','cathedral')" key="{bd429e6b-4ce4-4c4e-b7e5-40d3294b1f7a}" symbol="1" label="Building"/>
        </rule>
        <rule key="{d38e9eb4-bae6-4a24-8d16-f9da1fc8c301}" label="Artificial">
        ...
        <rule key="{4e00a170-d384-4164-85df-1f469968a079}" label="Natural">
          ...
          <rule filter="&quot;landuse&quot; = 'vineyard'" key="{d688efe0-2262-47f1-a1c7-3dc45b2498f6}" symbol="22" label="Vineyard"/>
          ...
          <rule filter="&quot;natural&quot; = 'scrub'" key="{d51c665f-19fa-402d-840a-98a023e73cce}" symbol="27" label="Scrub"/>
          <rule filter="&quot;landuse&quot; = 'allotments'" key="{c5698d20-3e5e-47d0-a912-32a40e3ee7f9}" symbol="28" label="Allotments"/>
          <rule filter="&quot;natural&quot; = 'scree'" key="{f9000d90-b85e-4e70-b1fc-135c93881d7c}" symbol="29" label="Scree"/>
        </rule>
        <rule key="{f1cde5de-5657-417b-82e1-642f707df83c}" label="Sport">
          <rule filter="&quot;leisure&quot; = 'pitch'" key="{0f9bf59c-4919-4630-87b0-5cc9bc6627c9}" symbol="30" label="Pitch"/>
          <rule filter="&quot;leisure&quot; IN ('stadium','sports_centre')" key="{c50c2598-da83-4281-9239-37f25918d018}" symbol="31" label="Stadium &amp; Sports Centre"/>
          <rule filter="&quot;leisure&quot; = 'track'" key="{0c7a99bd-a27d-4cac-8423-1eac4971c809}" symbol="32" label="Track"/>
        </rule>
      </rule>
      <rule scalemaxdenom="150000" key="{1a9237cf-1996-49d6-a15f-df2a21958cec}" scalemindenom="40000" label="Zoom 40-150K">
        <rule checkstate="0" filter="&quot;building&quot; is not null" key="{39f238ef-d96e-4682-8d87-9d5caee3844a}" label="Building">
          <rule checkstate="0" filter="&quot;building&quot; IN ( 'church','cathedral')" key="{842b7000-2eaa-46b6-b8d4-becd8859b1db}" symbol="33" label="Church"/>
          <rule filter="&quot;building&quot; NOT IN ( 'church','cathedral')" key="{ec2be41e-1c3e-40d3-a55c-eb0b0ff9332b}" symbol="34" label="Building"/>
        </rule>
        <rule key="{ac2b5385-6eee-4080-8bc4-22ab48fa43a9}" label="Artificial">
          <rule filter=" &quot;aeroway&quot; is not null or &quot;landuse&quot; IN ('industrial','brownfield','railway','construction')" key="{6b2b18e6-dffa-4ae9-953c-a4c756910148}" symbol="35" label="Industrial"/>
          <rule filter="&quot;landuse&quot; IN ('commercial')" key="{8d6b0135-a817-4ec4-a3f7-6c2c59105db2}" symbol="36" label="Commercial"/>
          <rule filter="&quot;landuse&quot; = 'residential'" key="{c9fb5dd8-0ea6-4e57-b661-4ee38d60be09}" symbol="37" label="residential"/>
          <rule filter=" &quot;landuse&quot; = 'cemetery'" key="{eb7036ad-553f-4703-b340-4ccd3b4f4306}" symbol="38" label="Cemetery"/>
          <rule filter=" &quot;amenity&quot;  IN ('parking', 'parking_space')" key="{e03040c4-7189-4ad8-a0e5-6ccc703eb26a}" symbol="39" label="Parking"/>
          <rule filter=" &quot;amenity&quot;  IN ('bicycle_parking')" key="{e1c3a4bc-b653-48fb-95aa-741ad644b93d}" symbol="40" label="Bicycle Parking"/>
          <rule filter=" &quot;highway&quot;  =  'pedestrian' " key="{b5904089-243f-4143-8424-4343cef98d46}" symbol="41" label="Pedestrian"/>
          <rule filter=" &quot;railway&quot; = 'platform'" key="{b8e803f3-fca1-488c-a05f-06c7426ec2d7}" symbol="42" label="Railway platform"/>
          <rule filter=" &quot;man_made&quot;  =  'pier' " key="{1bbfa44a-1cca-4a2f-a729-b14bcacf32f3}" symbol="43" label="Pier"/>
          <rule filter="&quot;landuse&quot;  IN ('military')" key="{1be36d6b-c1c2-4695-a420-c130a077e04a}" symbol="44" label="Military Area"/>
        </rule>
        <rule key="{1da81ae7-da05-4fe9-8df3-b7868a3d6d1d}" label="Natural">
          <rule filter="&quot;natural&quot; = 'water' or &quot;other_tags&quot; LIKE '%&quot;water&quot;%' or &quot;waterway&quot;='riverbank'" key="{911c0226-ef5d-4aef-9f8f-22fbde25204a}" symbol="45" label="Water"/>
          <rule filter="&quot;natural&quot;='beach'" key="{9e69b320-cfbc-40d4-81b7-814dc1520d8e}" symbol="46" label="Beach"/>
          <rule filter="&quot;natural&quot;='heath'" key="{63cef0a2-d4df-43f1-850c-d5d674393949}" symbol="47" label="Heath"/>
          <rule filter="&quot;natural&quot; = 'wetland'" key="{c8016b75-9c8d-422a-a6ed-cb8d2e7cc17c}" symbol="48" label="Wetland"/>
          <rule filter="&quot;landuse&quot; = 'forest' OR &quot;natural&quot; = 'wood'" key="{342200d2-bc1c-4298-8eef-a2b6a1b22504}" symbol="49" label="Forest"/>
          <rule filter="&quot;landuse&quot; = 'meadow'" key="{2b35f47f-b3b5-4260-aa32-7470a060aef5}" symbol="50" label="Meadow"/>
          <rule filter="&quot;landuse&quot; = 'farmland'" key="{740ec365-e6de-4bf7-b10a-206dbbb1d00a}" symbol="51" label="Farmland"/>
          <rule filter="&quot;landuse&quot; = 'farmyard'" key="{c3551161-f20b-4530-b4c2-8cfa7429ac89}" symbol="52" label="Farmyard"/>
          <rule filter="&quot;landuse&quot; = 'vineyard'" key="{cbc1ef50-0573-4021-82f4-b06921b9ad6a}" symbol="53" label="Vineyard"/>
          <rule filter="&quot;leisure&quot; = 'park'" key="{a6a05bd1-5558-4cac-b6a8-f6a84f4a36b3}" symbol="54" label="Park"/>
          <rule filter="&quot;leisure&quot; = 'golf_course'" key="{a4a2d463-6fed-4f89-80db-42b5e4e5cf61}" symbol="55" label="Golf"/>
          <rule filter="&quot;tourism&quot;='camp_site' OR &quot;tourism&quot;='caravan_site'" key="{8e04fd90-a379-484e-93b9-2a4c221b013e}" symbol="56" label="Camping"/>
          <rule filter=" &quot;landuse&quot; IN  ('village_green','grass') OR  &quot;leisure&quot; =  'garden' OR &quot;natural&quot;='grassland'" key="{294cbc96-ac37-4939-a925-c1e8c3bab78c}" symbol="57" label="Grass &amp; Garden"/>
          <rule filter="&quot;natural&quot; = 'scrub'" key="{3dd0d800-b921-418c-a5f0-54f1d81914b5}" symbol="58" label="Scrub"/>
          <rule filter="&quot;landuse&quot; = 'allotments'" key="{768ce16f-7de0-496c-8a52-9a0c31e80553}" symbol="59" label="Allotments"/>
          <rule filter="&quot;natural&quot; = 'scree'" key="{018293a1-0258-441c-bbb5-a277c874ab92}" symbol="60" label="Scree"/>
        </rule>
        <rule key="{4362ecb6-ccff-4513-aca5-74edae7eb688}" label="Sport">
          <rule filter="&quot;leisure&quot; = 'pitch'" key="{54c6346c-ac4b-4cbf-bba0-731113c839e2}" symbol="61" label="Pitch"/>
          <rule filter="&quot;leisure&quot; IN ('stadium','sports_centre')" key="{01094db5-5662-4098-abd4-a3ea2c2c6c7a}" symbol="62" label="Stadium &amp; Sports Centre"/>
          <rule filter="&quot;leisure&quot; = 'track'" key="{ee995fc7-95fd-423e-a559-3e4a8ce92c15}" symbol="63" label="Track"/>
        </rule>
      </rule>
      <rule scalemaxdenom="600000" key="{200f65b0-2c89-46ec-b4f1-84527df3ce7b}" scalemindenom="150000" label="Zoom 150-600K">
        <rule checkstate="0" filter="&quot;building&quot; is not null" key="{cf2510b8-c83f-4f96-8c4f-1074cb4309b3}" label="NO Building">
          <rule checkstate="0" filter="&quot;building&quot; IN ( 'church','cathedral')" key="{67cea3e3-f359-4fbf-a44a-4f111450a463}" symbol="64" label="Church"/>
          <rule checkstate="0" filter="&quot;building&quot; NOT IN ( 'church','cathedral')" key="{7a5ef3ad-db17-4d16-bf66-7e02e717c70f}" symbol="65" label="Building"/>
        </rule>
        <rule key="{4b4bd650-7304-4714-96fc-6341edd3cdf4}" label="Artificial">
          <rule filter=" &quot;aeroway&quot; is not null or &quot;landuse&quot; IN ('industrial','brownfield','railway','construction')" key="{bc4fb896-9f31-4521-80cf-bbe6ab5b2309}" symbol="66" label="Industrial"/>
          <rule checkstate="0" filter="&quot;landuse&quot; IN ('commercial')" key="{f601be8f-d855-4c62-bc99-511731d19e22}" symbol="67" label="NO Commercial"/>
          <rule filter="&quot;landuse&quot; = 'residential'" key="{5fed245b-b366-4c94-92ef-611dd6f5871c}" symbol="68" label="residential"/>
          <rule checkstate="0" filter=" &quot;landuse&quot; = 'cemetery'" key="{667b6887-7a37-4046-943f-a389653aac34}" symbol="69" label="Cemetery"/>
          <rule checkstate="0" filter=" &quot;amenity&quot;  IN ('parking', 'parking_space')" key="{cb975b09-8734-446b-abc9-25beb49fbcff}" symbol="70" label="NO Parking"/>
          <rule checkstate="0" filter=" &quot;amenity&quot;  IN ('bicycle_parking')" key="{52e1b3c2-fa65-4432-a293-f9ec383ac24c}" symbol="71" label="NO Bicycle Parking"/>
          <rule checkstate="0" filter=" &quot;highway&quot;  =  'pedestrian' " key="{4cc61540-e75f-4db5-9931-00fa4e862c2b}" symbol="72" label="NO Pedestrian"/>
          <rule checkstate="0" filter=" &quot;railway&quot; = 'platform'" key="{daed0ae5-b2aa-41e2-842b-750b01a7a01a}" symbol="73" label="NO Railway platform"/>
          <rule checkstate="0" filter=" &quot;man_made&quot;  =  'pier' " key="{24a729c5-f9f6-4c9b-815c-7787f4c483cd}" symbol="74" label="NO Pier"/>
        </rule>
        <rule key="{b1e9211c-dd3b-417a-b794-ded5f55e2f1c}" label="Natural">
          <rule filter="&quot;natural&quot; = 'water' or &quot;other_tags&quot; LIKE '%&quot;water&quot;%' or &quot;waterway&quot;='riverbank'" key="{f4af5422-553a-4e1c-bd54-c20aea37f18e}" symbol="75" label="Water"/>
          <rule filter="&quot;natural&quot;='beach'" key="{66d5b575-ddcd-44b7-adea-bc0a4590791c}" symbol="76" label="Beach"/>
          <rule filter="&quot;natural&quot;='heath'" key="{95f82f97-d853-454b-a746-ae33478d8cf9}" symbol="77" label="Heath"/>
          <rule filter="&quot;natural&quot; = 'wetland'" key="{3184889e-c899-4a15-ad69-e0de096bdfb7}" symbol="78" label="Wetland"/>
          <rule filter="&quot;landuse&quot; = 'forest' OR &quot;natural&quot; = 'wood'" key="{87cbe8e4-6aa5-4870-aa47-8bf9f532ca6d}" symbol="79" label="Forest"/>
          <rule filter="&quot;landuse&quot; = 'meadow'" key="{93708d90-def2-4919-9323-d32a19c4d912}" symbol="80" label="Meadow"/>
          <rule filter="&quot;landuse&quot; = 'farmland'" key="{58654ef6-e0f8-485f-a01d-7e64f4e70018}" symbol="81" label="Farmland"/>
          <rule filter="&quot;landuse&quot; = 'farmyard'" key="{f5c44af7-9831-40ac-92b3-6a8ca2706b9e}" symbol="82" label="Farmyard"/>
          <rule filter="&quot;landuse&quot; = 'vineyard'" key="{d26481c1-ed83-4053-9d47-0d6f9c5d9b65}" symbol="83" label="Vineyard"/>
          <rule filter="&quot;leisure&quot; = 'park'" key="{368aaf38-0209-41cf-a1b7-d27bdd31d720}" symbol="84" label="Park"/>
          <rule filter="&quot;leisure&quot; = 'golf_course'" key="{c3f27ebe-ec5b-469c-8569-39bcf55b3d45}" symbol="85" label="Golf"/>
          <rule filter="&quot;tourism&quot;='camp_site' OR &quot;tourism&quot;='caravan_site'" key="{6034d701-eed7-43b9-80f9-d584f03e82c7}" symbol="86" label="Camping"/>
          <rule filter=" &quot;landuse&quot; IN  ('village_green','grass') OR  &quot;leisure&quot; =  'garden' OR &quot;natural&quot;='grassland'" key="{3000f2bc-bbb8-4819-b514-a5e8d4feaed1}" symbol="87" label="Grass &amp; Garden"/>
        </rule>
        <rule checkstate="0" key="{7081d667-dc97-49a2-8b43-4362dfb09524}" label="NO Sport">
          <rule checkstate="0" filter="&quot;leisure&quot; = 'pitch'" key="{6a236207-e196-4780-ae48-28d687636b5b}" symbol="88" label="Pitch"/>
          <rule checkstate="0" filter="&quot;leisure&quot; IN ('stadium','sports_centre')" key="{ef46d61c-fccc-4063-9288-9b4211f9a6b4}" symbol="89" label="Stadium &amp; Sports Centre"/>
          <rule checkstate="0" filter="&quot;leisure&quot; = 'track'" key="{2d1bf608-5c2c-4e93-b9d1-66ce6edf5400}" symbol="90" label="Track"/>
        </rule>
      </rule>
      <rule filter="&quot;boundary&quot;='protected_area' AND &quot;leisure&quot;='nature_reserve'" key="{2c0cc801-e841-465d-82a6-90e14c09a2e9}" symbol="91" label="Protected Area"/>
    </rules>
    <symbols>
        ...
        <layer pass="7" class="LinePatternFill" locked="0">
          ...
          <symbol alpha="1" clip_to_extent="1" type="line" name="@13@0">
            <layer pass="0" class="SimpleLine" locked="0">
              ...
              <prop k="joinstyle" v="round"/>
              <prop k="line_color" v="255,0,0,26"/>
              <prop k="line_style" v="solid"/>
        ...
        <layer pass="4" class="PointPatternFill" locked="0">
          ...
          <symbol alpha="1" clip_to_extent="1" type="marker" name="@17@1">
            <layer pass="0" class="SimpleMarker" locked="0">
              ...
              <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
              <prop k="offset_unit" v="MM"/>
              <prop k="outline_color" v="181,208,208,255"/>
              <prop k="outline_style" v="solid"/>
              <prop k="outline_width" v="0"/>
              <prop k="outline_width_map_unit_scale" v="0,0,0,0,0,0"/>
              <prop k="outline_width_unit" v="MM"/>
            ...
            <layer pass="0" class="SimpleMarker" locked="0">
              ...
              <prop k="joinstyle" v="bevel"/>
              <prop k="name" v="line"/>
              <prop k="offset" v="-1.39999999999999991,-1.19999999999999996"/>
              <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
              <prop k="offset_unit" v="MM"/>
              <prop k="outline_color" v="181,208,208,255"/>
              <prop k="outline_style" v="solid"/>
        ...
        <layer pass="1" class="PointPatternFill" locked="0">
          ...
          <symbol alpha="1" clip_to_extent="1" type="marker" name="@22@1">
            <layer pass="0" class="SimpleMarker" locked="0">
              ...
              <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
              <prop k="offset_unit" v="MM"/>
              <prop k="outline_color" v="153,198,142,255"/>
              <prop k="outline_style" v="solid"/>
              <prop k="outline_width" v="0"/>
              <prop k="outline_width_map_unit_scale" v="0,0,0,0,0,0"/>
              <prop k="outline_width_unit" v="MM"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="25">
        <layer pass="2" class="SimpleFill" locked="0">
          ...
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="outline_color" v="195,216,170,255"/>
          <prop k="outline_style" v="solid"/>
          <prop k="outline_width" v="0.2"/>
          <prop k="outline_width_unit" v="MM"/>
          <prop k="style" v="solid"/>
        ...
        <layer pass="1" class="PointPatternFill" locked="0">
          ...
          <symbol alpha="1" clip_to_extent="1" type="marker" name="@27@1">
            ...
            <layer pass="0" class="SimpleMarker" locked="0">
              ...
              <prop k="joinstyle" v="bevel"/>
              <prop k="name" v="line"/>
              <prop k="offset" v="0.40000000000000002,-0.10000000000000001"/>
              <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
              <prop k="offset_unit" v="MM"/>
              <prop k="outline_color" v="153,198,142,255"/>
              <prop k="outline_style" v="solid"/>
            ...
            <layer pass="0" class="SimpleMarker" locked="0">
              ...
              <prop k="joinstyle" v="bevel"/>
              <prop k="name" v="line"/>
              <prop k="offset" v="-0.5,0.20000000000000001"/>
              <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
              <prop k="offset_unit" v="MM"/>
              <prop k="outline_color" v="153,198,142,255"/>
              <prop k="outline_style" v="solid"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="28">
        <layer pass="1" class="SimpleFill" locked="0">
          ...
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="outline_color" v="238,207,179,255"/>
          <prop k="outline_style" v="no"/>
          <prop k="outline_width" v="0.26"/>
          <prop k="outline_width_unit" v="MM"/>
          <prop k="style" v="solid"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="29">
        <layer pass="1" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="color" v="238,229,220,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="outline_color" v="238,229,220,255"/>
          <prop k="outline_style" v="no"/>
          <prop k="outline_width" v="0.26"/>
          <prop k="outline_width_unit" v="MM"/>
          <prop k="style" v="solid"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="3">
        <layer pass="2" class="SimpleFill" locked="0">
          ...
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="outline_color" v="148,125,118,255"/>
          <prop k="outline_style" v="solid"/>
          <prop k="outline_width" v="0.2"/>
          <prop k="outline_width_unit" v="MM"/>
          <prop k="style" v="solid"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="38">
        <layer pass="1" class="SimpleFill" locked="0">
          ...
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="outline_color" v="119,141,121,255"/>
          <prop k="outline_style" v="solid"/>
          <prop k="outline_width" v="0.2"/>
          <prop k="outline_width_unit" v="MM"/>
          <prop k="style" v="solid"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="78">
        ...
        <layer pass="4" class="PointPatternFill" locked="0">
          ...
          <prop k="outline_width_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="outline_width_unit" v="MM"/>
          <symbol alpha="1" clip_to_extent="1" type="marker" name="@78@1">
            <layer pass="0" class="SimpleMarker" locked="0">
              <prop k="angle" v="90"/>
              <prop k="color" v="255,0,0,255"/>
              <prop k="horizontal_anchor_point" v="1"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="83">
        ...
        <layer pass="1" class="PointPatternFill" locked="0">
          ...
          <prop k="outline_width_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="outline_width_unit" v="MM"/>
          <symbol alpha="1" clip_to_extent="1" type="marker" name="@83@1">
            <layer pass="0" class="SimpleMarker" locked="0">
              <prop k="angle" v="0"/>
              <prop k="color" v="255,0,0,255"/>
              <prop k="horizontal_anchor_point" v="1"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="fill" name="91">
        <layer pass="3" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="1"/>
          <prop k="joinstyle" v="round"/>
          <prop k="line_color" v="108,188,108,103"/>
          <prop k="line_style" v="solid"/>
        ...
        <layer pass="3" class="SimpleFill" locked="0">
          ...
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="outline_color" v="163,193,156,255"/>
          <prop k="outline_style" v="solid"/>
  ...
  <labeling type="rule-based">
    <rules key="{62d9cf74-5852-4a44-9b4d-58c41aa25a59}">
      <rule description="Building" filter="($area/ $scale)>0" key="{8857d54c-d5e2-4ff1-9969-8288531039aa}">
        <settings>
      ...
      <rule description="Parking" filter="&quot;amenity&quot; IN ('parking','parking_space')" key="{d270a765-d5d2-40e3-89a5-db6dd649fff5}">
        <settings>
      ...
      <rule scalemaxdenom="10000" description="School" filter="&quot;amenity&quot;='school' AND &quot;building&quot; IS NULL" key="{4fe87c54-66ee-4c77-ba29-0aefbd5dcde8}" scalemindenom="1">
        <settings>
      ...
      <rule description="Protected Area" filter="&quot;boundary&quot;='protected_area' AND &quot;leisure&quot;='nature_reserve'" key="{3807c9fb-774e-4e45-8ded-c846d4c383c3}">
        <settings>
