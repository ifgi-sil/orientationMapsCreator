...
<qgis version="2.18.22" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{2439e0f5-d5a7-45a4-b5c6-6e7c84f875c3}">
      <rule scalemaxdenom="4000" key="{c23779b1-aa53-4c35-b9da-753b59d5f3c3}" scalemindenom="1000" label="Scale_1_Building_1-4K">
        ...
        <rule filter=" &quot;clazz&quot; = 62" key="{7760f0f1-c3dd-468d-bd32-d5c4cb927b27}" symbol="10" label="Pedestrian"/>
        <rule filter=" &quot;clazz&quot; = 63" key="{a09d7a31-06bc-403f-bfac-21ff68d4599e}" symbol="11" label="Living Street"/>
        <rule filter=" &quot;clazz&quot; = 71" key="{c3c9da48-4c41-4092-91e2-19c2c0b18dcd}" symbol="12" label="Track"/>
      </rule>
      <rule scalemaxdenom="15000" key="{2ab36ab7-49e2-40a8-8378-36481f9cb0dc}" scalemindenom="4000" label="Scale_2_Suburban_4-15K">
        ...
        <rule checkstate="0" filter=" &quot;clazz&quot; = 51" key="{3b165c0d-51a0-4b12-ab49-394308effa8d}" symbol="22" label="Service"/>
        <rule filter=" &quot;clazz&quot; = 62" key="{8c2834f8-83d4-4818-abe3-6c2c519aef4b}" symbol="23" label="Pedestrian"/>
        <rule filter=" &quot;clazz&quot; = 63" key="{d5d70dc0-1222-4517-85fd-160e261429f5}" symbol="24" label="Living Street"/>
  ...
  <labeling type="rule-based">
    <rules key="{6ead350d-5783-4478-aaff-cc4daac75a32}">
      <rule scalemaxdenom="10000" description="Zoom 16" key="{64712a6d-a1c5-4cc2-8018-df3d06004775}" scalemindenom="1">
        <rule description="Pedestrian" filter=" &quot;clazz&quot; = 62" key="{c7507ca4-2d91-4f7d-aa34-1fa9de445dab}">
          <settings>
            <text-style fontItalic="1" fontFamily="Noto Sans" fontLetterSpacing="-0.1875" fontUnderline="0" fontWeight="75" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="30,30,30,255" fontSizeInMapUnits="0" isExpression="1" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="6" fieldName="replace(replace(replace(replace(replace(replace(&quot;osm_name&quot;,'Rue','R.'),'Impasse','Imp.'),'Place','Pl.'),'Boulevard','Bd'),'Avenue','Av.'),'Saint','St')" namedStyle="Bold Italic" fontWordSpacing="-0.1875" useSubstitutions="0">
              <substitutions/>
            </text-style>
        ...
        <rule description="Roads" filter="&quot;clazz&quot; >= 41 and &quot;clazz&quot; &lt;= 43" key="{20682463-acc4-46d0-9c1f-6a01c038c42c}">
          <settings>
            <text-style fontItalic="1" fontFamily="Noto Sans" fontLetterSpacing="0" fontUnderline="0" fontWeight="75" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="42,42,42,255" fontSizeInMapUnits="0" isExpression="1" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="6.5" fieldName="replace(replace(replace(replace(replace(&quot;osm_name&quot;,'Impasse','Imp.'),'Place','Pl.'),'Boulevard','Bd'),'Avenue','Av.'),'Saint','St')" namedStyle="Bold Italic" fontWordSpacing="0" useSubstitutions="0">
              <substitutions/>
            </text-style>
            <text-format placeDirectionSymbol="0" multilineAlign="0" rightDirectionSymbol=">" multilineHeight="1" plussign="0" addDirectionSymbol="0" leftDirectionSymbol="&lt;" formatNumbers="0" decimals="3" wrapChar="" reverseDirectionSymbol="0"/>
        ...
        <rule description="Tertiary" filter="&quot;clazz&quot; >= 31 and &quot;clazz&quot; &lt;= 32" key="{eab44db1-505e-415d-87fc-ef197712d9ba}">
          <settings>
            <text-style fontItalic="1" fontFamily="Noto Sans" fontLetterSpacing="0" fontUnderline="0" fontWeight="75" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="42,42,42,255" fontSizeInMapUnits="0" isExpression="1" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="6.5" fieldName="replace(replace(replace(replace(replace(&quot;osm_name&quot;,'Impasse','Imp.'),'Place','Pl.'),'Boulevard','Bd'),'Avenue','Av.'),'Saint','St')" namedStyle="Bold Italic" fontWordSpacing="0" useSubstitutions="0">
              <substitutions/>
            </text-style>
        ...
        <rule description="Secondary" filter="&quot;clazz&quot; >= 21 and &quot;clazz&quot; &lt;= 22" key="{ddc0655b-ca03-4565-9cbc-d85b125fb711}">
          <settings>
            <text-style fontItalic="1" fontFamily="Noto Sans" fontLetterSpacing="0" fontUnderline="0" fontWeight="75" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="42,42,42,255" fontSizeInMapUnits="0" isExpression="1" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="7" fieldName="replace(replace(replace(replace(replace(&quot;osm_name&quot;,'Impasse','Imp.'),'Place','Pl.'),'Boulevard','Bd'),'Avenue','Av.'),'Saint','St')" namedStyle="Bold Italic" fontWordSpacing="0" useSubstitutions="0">
              <substitutions/>
            </text-style>
            <text-format placeDirectionSymbol="0" multilineAlign="0" rightDirectionSymbol=">" multilineHeight="1" plussign="0" addDirectionSymbol="0" leftDirectionSymbol="&lt;" formatNumbers="0" decimals="3" wrapChar="" reverseDirectionSymbol="0"/>
            <text-buffer bufferSize="0.3" bufferSizeMapUnitScale="0,0,0,0,0,0" bufferColor="246,249,190,255" bufferDraw="1" bufferBlendMode="1" bufferTransp="0" bufferSizeInMapUnits="0" bufferNoFill="0" bufferJoinStyle="128"/>
        ...
        <rule description="Primary" filter=" &quot;clazz&quot; = 15" key="{05c7abb6-4bf6-4cda-9d27-6f1019985ed2}">
          <settings>
            <text-style fontItalic="1" fontFamily="Noto Sans" fontLetterSpacing="0" fontUnderline="0" fontWeight="75" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="1" textColor="42,42,42,255" fontSizeInMapUnits="0" isExpression="1" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="7" fieldName="replace(replace(replace(replace(replace(&quot;osm_name&quot;,'Impasse','Imp.'),'Place','Pl.'),'Boulevard','Bd'),'Avenue','Av.'),'Saint','St')" namedStyle="Bold Italic" fontWordSpacing="0" useSubstitutions="0">
              <substitutions/>
            </text-style>
            <text-format placeDirectionSymbol="0" multilineAlign="0" rightDirectionSymbol=">" multilineHeight="1" plussign="0" addDirectionSymbol="0" leftDirectionSymbol="&lt;" formatNumbers="0" decimals="3" wrapChar="" reverseDirectionSymbol="0"/>
        ...
        <rule description="Trunk" filter=" &quot;clazz&quot; = 13" key="{ca81b779-b4f3-43b7-b6f7-5ad0edf0c1fe}">
          <settings>
            <text-style fontItalic="1" fontFamily="Noto Sans" fontLetterSpacing="0" fontUnderline="0" fontWeight="75" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="1" textColor="42,42,42,255" fontSizeInMapUnits="0" isExpression="1" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="7" fieldName="replace(replace(replace(replace(replace(&quot;osm_name&quot;,'Impasse','Imp.'),'Place','Pl.'),'Boulevard','Bd'),'Avenue','Av.'),'Saint','St')" namedStyle="Bold Italic" fontWordSpacing="0" useSubstitutions="0">
              <substitutions/>
            </text-style>
      ...
      <rule scalemaxdenom="20000" description="Zoom 15" key="{c82d6b2a-651b-49ec-b53e-0f01b9ef7e0e}" scalemindenom="10000">
        <rule description="Pedestrian" filter=" &quot;clazz&quot; = 62" key="{0fccca48-3642-48a0-8b7e-922c5a74e4fd}">
          <settings>
            <text-style fontItalic="1" fontFamily="Noto Sans" fontLetterSpacing="-0.1875" fontUnderline="0" fontWeight="75" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="30,30,30,255" fontSizeInMapUnits="0" isExpression="1" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="5" fieldName="replace(replace(replace(replace(replace(replace(&quot;osm_name&quot;,'Rue','R.'),'Impasse','Imp.'),'Place','Pl.'),'Boulevard','Bd'),'Avenue','Av.'),'Saint','St')" namedStyle="Bold Italic" fontWordSpacing="-0.1875" useSubstitutions="0">
              <substitutions/>
            </text-style>
            <text-format placeDirectionSymbol="0" multilineAlign="0" rightDirectionSymbol=">" multilineHeight="1" plussign="0" addDirectionSymbol="0" leftDirectionSymbol="&lt;" formatNumbers="0" decimals="3" wrapChar="" reverseDirectionSymbol="0"/>
        ...
        <rule description="Roads" filter="&quot;clazz&quot; >= 41 and &quot;clazz&quot; &lt;= 43" key="{5cf085c3-0203-454f-917c-e4d1736cb3e7}">
          <settings>
            <text-style fontItalic="1" fontFamily="Noto Sans" fontLetterSpacing="0" fontUnderline="0" fontWeight="75" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="42,42,42,255" fontSizeInMapUnits="0" isExpression="1" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="6" fieldName="replace(replace(replace(replace(replace(&quot;osm_name&quot;,'Impasse','Imp.'),'Place','Pl.'),'Boulevard','Bd'),'Avenue','Av.'),'Saint','St')" namedStyle="Bold Italic" fontWordSpacing="0" useSubstitutions="0">
              <substitutions/>
            </text-style>
            <text-format placeDirectionSymbol="0" multilineAlign="0" rightDirectionSymbol=">" multilineHeight="1" plussign="0" addDirectionSymbol="0" leftDirectionSymbol="&lt;" formatNumbers="0" decimals="3" wrapChar="" reverseDirectionSymbol="0"/>
        ...
        <rule description="Tertiary" filter="&quot;clazz&quot; >= 31 and &quot;clazz&quot; &lt;= 32" key="{de4b990e-df08-426c-8863-51fae1de68ce}">
          <settings>
            <text-style fontItalic="1" fontFamily="Noto Sans" fontLetterSpacing="0" fontUnderline="0" fontWeight="75" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="42,42,42,255" fontSizeInMapUnits="0" isExpression="1" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="6" fieldName="replace(replace(replace(replace(replace(&quot;osm_name&quot;,'Impasse','Imp.'),'Place','Pl.'),'Boulevard','Bd'),'Avenue','Av.'),'Saint','St')" namedStyle="Bold Italic" fontWordSpacing="0" useSubstitutions="0">
              <substitutions/>
            </text-style>
        ...
        <rule description="Secondary" filter="&quot;clazz&quot; >= 21 and &quot;clazz&quot; &lt;= 22" key="{71e5bbc3-2dea-408c-9e95-b34bf877ed38}">
          <settings>
            <text-style fontItalic="1" fontFamily="Noto Sans" fontLetterSpacing="0" fontUnderline="0" fontWeight="75" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="42,42,42,255" fontSizeInMapUnits="0" isExpression="1" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="6" fieldName="replace(replace(replace(replace(replace(&quot;osm_name&quot;,'Impasse','Imp.'),'Place','Pl.'),'Boulevard','Bd'),'Avenue','Av.'),'Saint','St')" namedStyle="Bold Italic" fontWordSpacing="0" useSubstitutions="0">
              <substitutions/>
            </text-style>
        ...
        <rule description="Primary" filter=" &quot;clazz&quot; = 15" key="{782466fe-43b4-4025-a4e5-0615faffb3cc}">
          <settings>
            <text-style fontItalic="1" fontFamily="Noto Sans" fontLetterSpacing="0" fontUnderline="0" fontWeight="75" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="1" textColor="42,42,42,255" fontSizeInMapUnits="0" isExpression="1" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="6" fieldName="replace(replace(replace(replace(replace(&quot;osm_name&quot;,'Impasse','Imp.'),'Place','Pl.'),'Boulevard','Bd'),'Avenue','Av.'),'Saint','St')" namedStyle="Bold Italic" fontWordSpacing="0" useSubstitutions="0">
              <substitutions/>
            </text-style>
            <text-format placeDirectionSymbol="0" multilineAlign="0" rightDirectionSymbol=">" multilineHeight="1" plussign="0" addDirectionSymbol="0" leftDirectionSymbol="&lt;" formatNumbers="0" decimals="3" wrapChar="" reverseDirectionSymbol="0"/>
            <text-buffer bufferSize="0.3" bufferSizeMapUnitScale="0,0,0,0,0,0" bufferColor="251,213,164,255" bufferDraw="1" bufferBlendMode="1" bufferTransp="0" bufferSizeInMapUnits="0" bufferNoFill="0" bufferJoinStyle="128"/>
        ...
        <rule description="Trunk" filter=" &quot;clazz&quot; = 13" key="{f6e26456-0ecb-4c28-b1c3-a54228a02d07}">
          <settings>
            <text-style fontItalic="1" fontFamily="Noto Sans" fontLetterSpacing="0" fontUnderline="0" fontWeight="75" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="1" textColor="107,80,38,255" fontSizeInMapUnits="0" isExpression="1" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="6" fieldName="replace(replace(replace(replace(replace(&quot;osm_name&quot;,'Impasse','Imp.'),'Place','Pl.'),'Boulevard','Bd'),'Avenue','Av.'),'Saint','St')" namedStyle="Bold Italic" fontWordSpacing="0" useSubstitutions="0">
              <substitutions/>
            </text-style>
            <text-format placeDirectionSymbol="0" multilineAlign="0" rightDirectionSymbol=">" multilineHeight="1" plussign="0" addDirectionSymbol="0" leftDirectionSymbol="&lt;" formatNumbers="0" decimals="3" wrapChar="" reverseDirectionSymbol="0"/>
      ...
      <rule scalemaxdenom="40000" description="Zoom 14" key="{96b11100-910d-4385-a889-4cb2b85d2f1c}" scalemindenom="20000">
        <rule description="Motorway" filter=" &quot;clazz&quot; = 11" key="{0c6b1111-062b-4f26-90ee-d61f4c75d857}">
          <settings>
            <text-style fontItalic="0" fontFamily="Noto Sans" fontLetterSpacing="0" fontUnderline="0" fontWeight="50" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="131,56,81,255" fontSizeInMapUnits="0" isExpression="1" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="6" fieldName="ref" namedStyle="Bold Italic" fontWordSpacing="0" useSubstitutions="0">
              <substitutions/>
            </text-style>
            <text-format placeDirectionSymbol="0" multilineAlign="0" rightDirectionSymbol=">" multilineHeight="1" plussign="0" addDirectionSymbol="0" leftDirectionSymbol="&lt;" formatNumbers="0" decimals="3" wrapChar="" reverseDirectionSymbol="0"/>
        ...
        <rule description="Trunk" filter=" &quot;clazz&quot; = 13" key="{b0882f13-2062-41ba-8807-c9409759eaba}">
          <settings>
            <text-style fontItalic="0" fontFamily="Noto Sans" fontLetterSpacing="0" fontUnderline="0" fontWeight="50" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="112,51,36,255" fontSizeInMapUnits="0" isExpression="1" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="6" fieldName="ref" namedStyle="Bold Italic" fontWordSpacing="0" useSubstitutions="0">
              <substitutions/>
            </text-style>
            <text-format placeDirectionSymbol="0" multilineAlign="0" rightDirectionSymbol=">" multilineHeight="1" plussign="0" addDirectionSymbol="0" leftDirectionSymbol="&lt;" formatNumbers="0" decimals="3" wrapChar="" reverseDirectionSymbol="0"/>
            <text-buffer bufferSize="1" bufferSizeMapUnitScale="0,0,0,0,0,0" bufferColor="255,255,255,255" bufferDraw="0" bufferBlendMode="0" bufferTransp="0" bufferSizeInMapUnits="0" bufferNoFill="0" bufferJoinStyle="64"/>
        ...
        <rule description="Primary" filter=" &quot;clazz&quot; = 15" key="{731b8698-dd64-45dc-ad44-5f70e8b7aa41}">
          <settings>
            <text-style fontItalic="1" fontFamily="Noto Sans" fontLetterSpacing="0" fontUnderline="0" fontWeight="75" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="107,80,38,255" fontSizeInMapUnits="0" isExpression="1" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="6" fieldName="ref" namedStyle="Bold Italic" fontWordSpacing="0" useSubstitutions="0">
              <substitutions/>
            </text-style>
            <text-format placeDirectionSymbol="0" multilineAlign="0" rightDirectionSymbol=">" multilineHeight="1" plussign="0" addDirectionSymbol="0" leftDirectionSymbol="&lt;" formatNumbers="0" decimals="3" wrapChar="" reverseDirectionSymbol="0"/>
            <text-buffer bufferSize="1" bufferSizeMapUnitScale="0,0,0,0,0,0" bufferColor="255,255,255,255" bufferDraw="0" bufferBlendMode="0" bufferTransp="0" bufferSizeInMapUnits="0" bufferNoFill="0" bufferJoinStyle="64"/>
        ...
        <rule description="Secondary" filter="&quot;clazz&quot; >= 21 and &quot;clazz&quot; &lt;= 22" key="{1c998d4c-cce8-4ce1-861e-ff0e9faeedc7}">
          <settings>
            <text-style fontItalic="1" fontFamily="Noto Sans" fontLetterSpacing="0" fontUnderline="0" fontWeight="75" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="39,42,19,255" fontSizeInMapUnits="0" isExpression="0" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="5.5" fieldName="osm_name" namedStyle="Bold Italic" fontWordSpacing="0" useSubstitutions="0">
              <substitutions/>
            </text-style>
            <text-format placeDirectionSymbol="0" multilineAlign="0" rightDirectionSymbol=">" multilineHeight="1" plussign="0" addDirectionSymbol="0" leftDirectionSymbol="&lt;" formatNumbers="0" decimals="3" wrapChar="" reverseDirectionSymbol="0"/>
        ...
        <rule description="Tertiary" filter="&quot;clazz&quot; >= 31 and &quot;clazz&quot; &lt;= 32" key="{d6657ee3-83e5-44a6-b24a-388aeb57cea7}">
          <settings>
            <text-style fontItalic="1" fontFamily="Noto Sans" fontLetterSpacing="0" fontUnderline="0" fontWeight="75" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="26,26,26,255" fontSizeInMapUnits="0" isExpression="0" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="5.5" fieldName="osm_name" namedStyle="Bold Italic" fontWordSpacing="0" useSubstitutions="0">
              <substitutions/>
            </text-style>
            <text-format placeDirectionSymbol="0" multilineAlign="0" rightDirectionSymbol=">" multilineHeight="1" plussign="0" addDirectionSymbol="0" leftDirectionSymbol="&lt;" formatNumbers="0" decimals="3" wrapChar="" reverseDirectionSymbol="0"/>
      ...
      <rule scalemaxdenom="80000" description="Zoom 13" key="{0a03e0c3-cd0e-4fb4-93b6-b305f1f72d67}" scalemindenom="40000">
        <rule description="Motorway" filter=" &quot;clazz&quot; = 11" key="{ea95c224-a376-4bf8-afa4-d906e4e0845d}">
          <settings>
            <text-style fontItalic="0" fontFamily="Noto Sans" fontLetterSpacing="0" fontUnderline="0" fontWeight="50" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="131,56,81,255" fontSizeInMapUnits="0" isExpression="1" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="6" fieldName="ref" namedStyle="Bold Italic" fontWordSpacing="0" useSubstitutions="0">
              <substitutions/>
            </text-style>
        ...
        <rule description="Trunk" filter=" &quot;clazz&quot; = 13" key="{02106ba8-dcd6-4e67-b6b9-bf92ea613b06}">
          <settings>
            <text-style fontItalic="0" fontFamily="Noto Sans" fontLetterSpacing="0" fontUnderline="0" fontWeight="50" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="112,51,36,255" fontSizeInMapUnits="0" isExpression="1" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="6" fieldName="ref" namedStyle="Bold Italic" fontWordSpacing="0" useSubstitutions="0">
              <substitutions/>
            </text-style>
        ...
        <rule description="Primary" filter=" &quot;clazz&quot; = 15" key="{ef08e1bd-20de-48c9-af8f-e8af25b22135}">
          <settings>
            <text-style fontItalic="0" fontFamily="Noto Sans" fontLetterSpacing="0" fontUnderline="0" fontWeight="50" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="107,80,38,255" fontSizeInMapUnits="0" isExpression="1" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="6" fieldName="ref" namedStyle="Bold Italic" fontWordSpacing="0" useSubstitutions="0">
              <substitutions/>
            </text-style>
            <text-format placeDirectionSymbol="0" multilineAlign="0" rightDirectionSymbol=">" multilineHeight="1" plussign="0" addDirectionSymbol="0" leftDirectionSymbol="&lt;" formatNumbers="0" decimals="3" wrapChar="" reverseDirectionSymbol="0"/>
            <text-buffer bufferSize="1" bufferSizeMapUnitScale="0,0,0,0,0,0" bufferColor="255,255,255,255" bufferDraw="0" bufferBlendMode="0" bufferTransp="0" bufferSizeInMapUnits="0" bufferNoFill="0" bufferJoinStyle="64"/>
        ...
        <rule description="Secondary" filter="&quot;clazz&quot; >= 21 and &quot;clazz&quot; &lt;= 22" key="{86f2175e-8555-48b2-95d1-7cce042b3aaa}">
          <settings>
            <text-style fontItalic="0" fontFamily="Noto Sans" fontLetterSpacing="0" fontUnderline="0" fontWeight="50" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="88,94,44,255" fontSizeInMapUnits="0" isExpression="1" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="6" fieldName="ref" namedStyle="Bold Italic" fontWordSpacing="0" useSubstitutions="0">
              <substitutions/>
            </text-style>
            <text-format placeDirectionSymbol="0" multilineAlign="0" rightDirectionSymbol=">" multilineHeight="1" plussign="0" addDirectionSymbol="0" leftDirectionSymbol="&lt;" formatNumbers="0" decimals="3" wrapChar="" reverseDirectionSymbol="0"/>
            <text-buffer bufferSize="1" bufferSizeMapUnitScale="0,0,0,0,0,0" bufferColor="255,255,255,255" bufferDraw="0" bufferBlendMode="0" bufferTransp="0" bufferSizeInMapUnits="0" bufferNoFill="0" bufferJoinStyle="64"/>
        ...
        <rule description="Tertiary" filter="&quot;clazz&quot; >= 31 and &quot;clazz&quot; &lt;= 32" key="{d55b6ef7-69ff-4bb4-9bb3-ddb5f2e6e94a}">
          <settings>
            <text-style fontItalic="0" fontFamily="Noto Sans" fontLetterSpacing="0" fontUnderline="0" fontWeight="50" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="111,113,111,255" fontSizeInMapUnits="0" isExpression="1" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="6" fieldName="ref" namedStyle="Bold Italic" fontWordSpacing="0" useSubstitutions="0">
              <substitutions/>
            </text-style>
            <text-format placeDirectionSymbol="0" multilineAlign="0" rightDirectionSymbol=">" multilineHeight="1" plussign="0" addDirectionSymbol="0" leftDirectionSymbol="&lt;" formatNumbers="0" decimals="3" wrapChar="" reverseDirectionSymbol="0"/>
            <text-buffer bufferSize="1" bufferSizeMapUnitScale="0,0,0,0,0,0" bufferColor="255,255,255,255" bufferDraw="0" bufferBlendMode="0" bufferTransp="0" bufferSizeInMapUnits="0" bufferNoFill="0" bufferJoinStyle="64"/>
