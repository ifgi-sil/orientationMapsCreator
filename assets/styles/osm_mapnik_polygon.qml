...
<qgis version="2.18.22" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <labeling type="rule-based">
    <rules key="{1cc45b7e-364a-4111-992b-93092249cf1c}">
      <rule description="Building" filter="($area/ $scale)>0" key="{2dc694fe-8eed-43c1-8e09-9406280c08d3}">
        <settings>
      ...
      <rule description="Parking" filter="&quot;amenity&quot; IN ('parking','parking_space')" key="{5901bb6c-40e8-4b76-9e36-47a790825f42}">
        <settings>
      ...
      <rule scalemaxdenom="10000" description="School" filter="&quot;amenity&quot;='school' AND &quot;building&quot; IS NULL" key="{3e6c77bf-fb6e-4ec4-a499-d793ff9c3f7c}" scalemindenom="1">
        <settings>
      ...
      <rule description="Protected Area" filter="&quot;boundary&quot;='protected_area' AND &quot;leisure&quot;='nature_reserve'" key="{25ae8da8-1f77-4ea5-b859-329f5e14ba40}">
        <settings>
