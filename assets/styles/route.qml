...
<qgis version="2.18.22" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="path_name">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="_path_seq">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="_start_vid">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="_end_vid">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="_node">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="_edge">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="_cost">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="_agg_cost">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    ...
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="line_color" v="44,72,161,255"/>
  ...
  <displayfield>path_name</displayfield>
  <label>0</label>
  <labelattributes>
  ...
  <aliases>
    ...
    <alias field="path_name" index="1" name=""/>
    <alias field="_path_seq" index="2" name=""/>
    <alias field="_start_vid" index="3" name=""/>
    <alias field="_end_vid" index="4" name=""/>
    <alias field="_node" index="5" name=""/>
    <alias field="_edge" index="6" name=""/>
    <alias field="_cost" index="7" name=""/>
    <alias field="_agg_cost" index="8" name=""/>
    <alias field="id" index="9" name=""/>
    <alias field="osm_id" index="10" name=""/>
    <alias field="osm_name" index="11" name=""/>
    <alias field="osm_meta" index="12" name=""/>
    <alias field="osm_source_id" index="13" name=""/>
    <alias field="osm_target_id" index="14" name=""/>
    <alias field="clazz" index="15" name=""/>
    <alias field="flags" index="16" name=""/>
    <alias field="source" index="17" name=""/>
    <alias field="target" index="18" name=""/>
    <alias field="km" index="19" name=""/>
    <alias field="kmh" index="20" name=""/>
    <alias field="cost" index="21" name=""/>
    <alias field="reverse_cost" index="22" name=""/>
    <alias field="x1" index="23" name=""/>
    <alias field="y1" index="24" name=""/>
    <alias field="x2" index="25" name=""/>
    <alias field="y2" index="26" name=""/>
    <alias field="geom" index="27" name=""/>
    <alias field="oneway" index="28" name=""/>
    <alias field="dir" index="29" name=""/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="path_name"/>
      <column width="-1" hidden="0" type="field" name="_path_seq"/>
      <column width="-1" hidden="0" type="field" name="_start_vid"/>
      <column width="-1" hidden="0" type="field" name="_end_vid"/>
      <column width="-1" hidden="0" type="field" name="_node"/>
      <column width="-1" hidden="0" type="field" name="_edge"/>
      <column width="-1" hidden="0" type="field" name="_cost"/>
      <column width="-1" hidden="0" type="field" name="_agg_cost"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="path_name" expression=""/>
    <default field="_path_seq" expression=""/>
    <default field="_start_vid" expression=""/>
    <default field="_end_vid" expression=""/>
    <default field="_node" expression=""/>
    <default field="_edge" expression=""/>
    <default field="_cost" expression=""/>
    <default field="_agg_cost" expression=""/>
  ...
  <previewExpression>COALESCE( "path_name", '&lt;NULL>' )</previewExpression>
