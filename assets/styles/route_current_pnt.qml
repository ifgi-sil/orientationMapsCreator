...
<qgis version="2.18.22" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{52f7c487-1ecc-4844-aeba-ee70a670abed}">
      <rule scalemaxdenom="10000" filter="$id=$atlasfeatureid" key="{9f99875b-9aa1-4849-b3bf-3ea6b9a8f686}" symbol="0" scalemindenom="1" label="0 - 10000"/>
      <rule scalemaxdenom="25000" filter="$id=$atlasfeatureid" key="{68936b78-5319-448e-87b5-7a0117a4a491}" symbol="1" scalemindenom="10000" label="10000 - 25000"/>
      <rule scalemaxdenom="100000" filter="$id=$atlasfeatureid" key="{aebd065e-fef7-4344-aa16-826e4c91e12c}" symbol="2" scalemindenom="25000" label="25000 - 100000"/>
      <rule scalemaxdenom="1000000" filter="$id=$atlasfeatureid" key="{561ea2b2-4643-4b5b-9e3e-9d05b1a0e0af}" symbol="3" scalemindenom="100000" label="100000 - 1000000"/>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="marker" name="0">
        <layer pass="0" class="SimpleMarker" locked="0">
          ...
          <prop k="angle_dd_expression" v="&quot;angle&quot;"/>
          <prop k="angle_dd_field" v=""/>
          <prop k="angle_dd_useexpr" v="1"/>
          <prop k="color" v="254,254,254,191"/>
          ...
          <prop k="outline_color" v="254,254,254,191"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="marker" name="3">
        <layer pass="0" class="SimpleMarker" locked="0">
          ...
          <prop k="angle_dd_field" v=""/>
          <prop k="angle_dd_useexpr" v="1"/>
          <prop k="color" v="255,255,255,191"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="name" v="circle"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="outline_color" v="255,255,255,191"/>
          <prop k="outline_style" v="solid"/>
          <prop k="outline_width" v="0"/>
          <prop k="outline_width_map_unit_scale" v="0,0,0,0,0,0"/>
          <prop k="outline_width_unit" v="MM"/>
  ...
  <annotationform>../../Experiment/QGIS</annotationform>
  <aliases>
  ...
  <editform>../../Experiment/QGIS</editform>
  <editforminit/>
  <editforminitcodesource>0</editforminitcodesource>
  <editforminitfilepath>../../Experiment/QGIS</editforminitfilepath>
...
def my_form_open(dialog, layer, feature):
  ...
  <previewExpression>COALESCE("osm_name", '&lt;NULL>')</previewExpression>
