...
<qgis version="2.18.22" simplifyAlgorithm="0" minimumScale="10000" maximumScale="1e+06" simplifyDrawingHints="1" minLabelScale="1" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
  ...
  <renderer-v2 forceraster="0" symbollevels="1" type="RuleRenderer" enableorderby="0">
    <rules key="{4489a135-7b2e-4408-a358-5be84ca97937}">
      <rule scalemaxdenom="2000000" filter="clazz >= 11 and clazz &lt;= 12" key="{de570205-1435-401b-8884-3de0894cac20}" scalemindenom="1" label="highway">
        <rule scalemaxdenom="10000" key="{20671273-b7a2-47ed-a7c7-a0a32a4f0d9c}" symbol="0" scalemindenom="1" label="1 - 10000"/>
        <rule scalemaxdenom="25000" key="{f8af6a6b-e2d8-4222-b6bc-c2e488ae6ec9}" symbol="1" scalemindenom="10000" label="10000 - 25000"/>
        <rule scalemaxdenom="50000" key="{b7cc86b0-9d4b-44a2-b663-2690e9342df4}" symbol="2" scalemindenom="25000" label="25000 - 50000"/>
        <rule scalemaxdenom="100000" key="{326bbde4-0078-4ce4-9de8-69ad2c61e3ee}" symbol="3" scalemindenom="50000" label="50000 - 100000"/>
        <rule scalemaxdenom="200000" key="{3cb679b5-1b94-4d91-a7a7-9b97cba4c02f}" symbol="4" scalemindenom="100000" label="100000 - 200000"/>
        <rule scalemaxdenom="1000000" key="{ea3292d5-fe50-4f51-91b8-6cceb97dd358}" symbol="5" scalemindenom="200000" label="200000 - 1000000"/>
        <rule scalemaxdenom="2000000" key="{b521710f-6041-475e-af88-8376e61c8db2}" symbol="6" scalemindenom="1000000" label="1000000 - 2000000"/>
      </rule>
      <rule scalemaxdenom="2000000" filter="clazz >= 13 and clazz &lt;= 14" key="{46d22213-c06f-43fa-826b-e9c884c180cb}" scalemindenom="1" label="trunk">
        <rule scalemaxdenom="10000" key="{a7a796d4-a910-4ca7-a450-78ace25fe17f}" symbol="7" scalemindenom="1000" label="0 - 10000"/>
        <rule scalemaxdenom="25000" key="{a3af3e05-72ad-4b17-933e-6c5317beab55}" symbol="8" scalemindenom="10000" label="10000 - 25000"/>
        <rule scalemaxdenom="50000" key="{bcb220b0-846f-4178-ba88-d13a69a681b1}" symbol="9" scalemindenom="25000" label="25000 - 50000"/>
        <rule scalemaxdenom="100000" key="{ccefaaa5-af04-41b0-a3ec-7c47a5fa3d89}" symbol="10" scalemindenom="50000" label="50000 - 100000"/>
        <rule scalemaxdenom="200000" key="{7ba835e5-9c48-44af-a4b8-41e10444a05a}" symbol="11" scalemindenom="100000" label="100000 - 200000"/>
        <rule scalemaxdenom="1000000" key="{22e67d5b-b476-47a4-a191-d26e8c896791}" symbol="12" scalemindenom="200000" label="200000 - 1000000"/>
        <rule scalemaxdenom="2000000" key="{c26aa8ca-d69c-47f3-9143-608b3abe7729}" symbol="13" scalemindenom="1000000" label="1000000 - 2000000"/>
      </rule>
      <rule scalemaxdenom="2000000" filter="clazz >= 15 and clazz &lt;= 16" key="{5c4552b7-6edb-4c75-ac01-ce438bb363ce}" scalemindenom="1" label="primary">
        <rule scalemaxdenom="10000" key="{75f77932-bc8f-4ba6-9fb7-ca405f6056f6}" symbol="14" scalemindenom="1" label="1 - 10000"/>
        <rule scalemaxdenom="25000" key="{24df00d5-b6ba-4cbc-a4c4-2b919e443625}" symbol="15" scalemindenom="10000" label="10000 - 25000"/>
        <rule scalemaxdenom="50000" key="{56906a87-f569-41b5-b594-aea54cce7644}" symbol="16" scalemindenom="25000" label="25000 - 50000"/>
        <rule scalemaxdenom="100000" key="{2727656f-aafa-456d-94b5-ccab38989eea}" symbol="17" scalemindenom="50000" label="50000 - 100000"/>
        <rule scalemaxdenom="200000" key="{835a2116-4774-4d76-9f18-29cd0551e0dd}" symbol="18" scalemindenom="100000" label="100000 - 200000"/>
        <rule scalemaxdenom="1000000" key="{dfdf45d8-8140-4ff1-94c9-67ca70d0b9fd}" symbol="19" scalemindenom="200000" label="200000 - 1000000"/>
        <rule scalemaxdenom="2000000" key="{157e5786-15bf-41c4-8bae-910eafe65556}" symbol="20" scalemindenom="1000000" label="1000000 - 2000000"/>
      </rule>
      <rule scalemaxdenom="500000" filter="clazz >= 21 and clazz &lt;= 22" key="{eac9e75e-b99c-4f26-b646-5c2d99131d9a}" scalemindenom="1" label="secondary">
        <rule scalemaxdenom="10000" key="{359e7b5f-2789-4b72-8d62-62af616534ab}" symbol="21" label="0 - 10000"/>
        <rule scalemaxdenom="25000" key="{b05b7f11-5bf7-482f-9101-fed0dee1b603}" symbol="22" scalemindenom="10000" label="10000 - 25000"/>
        <rule scalemaxdenom="50000" key="{6c88cfcc-c54d-4732-9fc7-de6c066e3b07}" symbol="23" scalemindenom="25000" label="25000 - 50000"/>
        <rule scalemaxdenom="100000" key="{57d67cf0-0f30-4b2b-9dd3-efd30627670b}" symbol="24" scalemindenom="50000" label="50000 - 100000"/>
        <rule scalemaxdenom="200000" key="{63bedc62-09c8-4bce-9ae7-f28b6fa4d56b}" symbol="25" scalemindenom="100000" label="100000 - 200000"/>
        <rule scalemaxdenom="500000" key="{6cb5e6a7-bb4e-4e3f-98e2-562693af8ad0}" symbol="26" scalemindenom="200000" label="200000 - 500000"/>
      </rule>
      <rule scalemaxdenom="200000" filter="clazz >= 31 and clazz &lt;=32" key="{1c4dc3ec-1e6a-45a6-8e49-d48a5d3e2b2a}" scalemindenom="1" label="tertiary">
        <rule scalemaxdenom="10000" key="{ee3e08a6-73c9-47f8-ba91-81bab3b38e36}" symbol="27" label="0 - 10000"/>
        <rule scalemaxdenom="25000" key="{55d0f83a-8c99-449d-afeb-648412b59087}" symbol="28" scalemindenom="10000" label="10000 - 25000"/>
        <rule scalemaxdenom="50000" key="{8e8517af-6575-4867-9626-6fd43f7de314}" symbol="29" scalemindenom="25000" label="25000 - 50000"/>
        <rule scalemaxdenom="100000" key="{0172577a-6623-4350-bd24-d700cfbfce64}" symbol="30" scalemindenom="50000" label="50000 - 100000"/>
        <rule scalemaxdenom="200000" key="{8c6e1cee-16b9-419d-b497-5c42ec6552f9}" symbol="31" scalemindenom="100000" label="100000 - 200000"/>
      </rule>
      <rule scalemaxdenom="100000" filter="clazz > 32" key="{518ccfa0-7aef-476c-97f4-55ca3931683f}" scalemindenom="1" label="residential">
        <rule scalemaxdenom="10000" key="{b52ff209-8f94-4120-ad4b-0a755260ebda}" symbol="32" scalemindenom="1" label="0 - 10000"/>
        <rule scalemaxdenom="25000" key="{c814c1a3-d932-462d-93e7-f637bda50c69}" symbol="33" scalemindenom="10000" label="10000 - 25000"/>
        <rule scalemaxdenom="50000" key="{4fe956d0-cac4-4791-9e92-94b35adfd314}" symbol="34" scalemindenom="25000" label="25000 - 50000"/>
        <rule scalemaxdenom="100000" key="{7f0e6678-41e0-4bec-9255-ac637b1801ab}" symbol="35" scalemindenom="50000" label="50000 - 100000"/>
      </rule>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="line" name="0">
        <layer pass="3" class="SimpleLine" locked="0">
          ...
          <prop k="line_color" v="224,46,107,255"/>
        ...
        <layer pass="6" class="SimpleLine" locked="0">
          ...
          <prop k="line_color" v="233,144,160,255"/>
          <prop k="line_style" v="solid"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="10">
        <layer pass="3" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="205,83,46,255"/>
          <prop k="line_style" v="solid"/>
        ...
        <layer pass="5" class="SimpleLine" locked="0">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="round"/>
          <prop k="line_color" v="251,178,154,255"/>
          <prop k="line_style" v="solid"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="14">
        <layer pass="1" class="SimpleLine" locked="1">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="167,118,17,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="3"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="21">
        <layer pass="1" class="SimpleLine" locked="1">
          ...
          <prop k="draw_inside_polygon" v="0"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="line_color" v="124,137,0,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="2.5"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="0"/>
  ...
  <annotationform>../misc</annotationform>
  <aliases>
  ...
  <editform>../misc</editform>
  <editforminit/>
  <editforminitcodesource>0</editforminitcodesource>
  <editforminitfilepath>../misc</editforminitfilepath>
