...
<qgis version="2.18.22" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{2439e0f5-d5a7-45a4-b5c6-6e7c84f875c3}">
      <rule scalemaxdenom="100000" key="{c23779b1-aa53-4c35-b9da-753b59d5f3c3}" scalemindenom="1" label="Zoom 1-100K">
        <rule checkstate="0" filter="&quot;highway&quot; is not null" key="{4fabebec-ebd2-4669-9e44-29ef05dee6c0}" label="Roads">
        ...
        <rule checkstate="0" key="{226306c0-7cc1-4fe5-b858-5a14d866441b}" label="Path">
        ...
        <rule key="{67dd8e1f-d066-47af-9c00-5943935b2e11}" label="Rails">
          <rule filter="&quot;railway&quot;  =  'rail' AND  NOT (&quot;tags&quot;  LIKE  '%&quot;usage&quot;=>&quot;industrial&quot;%' OR &quot;tags&quot; ILIKE '%&quot;service&quot;=>&quot;yard&quot;%')" key="{62699a08-c7b5-4335-b690-03766c4c9066}" label="Rails">
          ...
          <rule filter="&quot;railway&quot; = 'rail' AND (&quot;tags&quot; ILIKE '%&quot;usage&quot;=>&quot;industrial&quot;%' OR &quot;tags&quot; ILIKE '%&quot;service&quot;=>&quot;yard&quot;%')" key="{d7408843-bc43-4e4f-8088-c589ce3a0a40}" symbol="50" label="Rails industrial"/>
        ...
        <rule checkstate="0" filter="&quot;private&quot;='yes'" key="{b1b7ed46-3eaa-4f39-b5b3-d5493b25aa6a}" symbol="53" label="Private"/>
        <rule filter="&quot;waterway&quot; in ('river')" key="{402a4590-c6d8-420e-8fc9-d4ab7738749f}" label="River">
          <rule key="{97c62eb8-ade3-459c-8ff7-c003467b8968}" symbol="54" label="River"/>
        </rule>
        <rule filter="&quot;waterway&quot; in ('stream')" key="{25cac8ee-5511-4e21-aa18-66ce2751bcc1}" label="Stream">
          <rule key="{a87b18d8-e10e-4213-a797-85fba0361121}" symbol="55" label="Stream"/>
        </rule>
        <rule filter="&quot;waterway&quot; in ('canal')" key="{022a2572-414b-4ba2-8d99-39b316be9fec}" label="Canal">
          <rule key="{fb6f4003-a930-4092-b70f-e699dd898d2e}" symbol="56" label="Canal"/>
        </rule>
        <rule checkstate="0" filter="&quot;barrier&quot;='city_wall'" key="{9b2a50dd-4cb7-4b76-9b93-135875db0c91}" symbol="57" label="City Wall"/>
      </rule>
      <rule scalemaxdenom="200000" key="{04045133-bd48-4850-8d91-3df4f963b623}" scalemindenom="100000" label="Zoom 100-200K">
        <rule checkstate="0" filter="&quot;highway&quot; is not null" key="{409aa0df-a9a5-4c3e-878a-32eaafc78faa}" label="Roads">
          <rule filter="&quot;highway&quot; IN ('motorway','motorway_link')" key="{54889b8d-f97f-47b8-964b-7b06130df41c}" label="Motorway">
            <rule filter="(&quot;bridge&quot; IS NULL OR &quot;bridge&quot; IN ('no')) AND (&quot;tunnel&quot; IS NULL OR &quot;tunnel&quot; IN ('no')) AND (&quot;layer&quot; IS NULL OR &quot;layer&quot; &lt;> '-%')" key="{8b318367-663e-4e4c-97b7-18347efd7bdf}" symbol="58" label="Motorway"/>
            <rule filter="&quot;bridge&quot; IS NOT NULL AND &quot;bridge&quot; NOT IN ('no')" key="{bc526130-e491-4496-ad55-cb98ddf252df}" symbol="59" label="Motorway - Bridge"/>
            <rule filter="(&quot;tunnel&quot; IS NOT NULL AND &quot;tunnel&quot; NOT IN ('no')) OR (&quot;layer&quot; IS NOT NULL AND &quot;layer&quot; = '-%')" key="{3e2d4699-8b7b-4d79-b0a5-9af035d95453}" symbol="60" label="Motorway - Tunnel"/>
          </rule>
          <rule description="trunk &amp; primary" filter="&quot;highway&quot; IN ('trunk')" key="{4df60a98-0b68-47d8-bacd-5479e538d3d6}" label="Trunk">
            <rule filter="(&quot;bridge&quot; IS NULL OR &quot;bridge&quot; IN ('no')) AND (&quot;tunnel&quot; IS NULL OR &quot;tunnel&quot; IN ('no')) AND (&quot;layer&quot; IS NULL OR &quot;layer&quot; &lt;> '-%')" key="{2f8e7b01-b067-4d5c-9a7f-d45ebf979d75}" symbol="61" label="Trunk"/>
            <rule filter="&quot;bridge&quot; IS NOT NULL AND &quot;bridge&quot; NOT IN ('no') " key="{a9bb8952-a431-4bec-8184-949dc401d81e}" symbol="62" label="Trunk - Bridge"/>
            <rule filter="(&quot;tunnel&quot; IS NOT NULL AND &quot;tunnel&quot; NOT IN ('no')) OR (&quot;layer&quot; IS NOT NULL AND &quot;layer&quot; = '-%')" key="{e1af1339-a53b-44a7-80b9-499162888b39}" symbol="63" label="Trunk - Tunnel"/>
          </rule>
          <rule description="trunk &amp; primary" filter="&quot;highway&quot; IN ('trunk_link')" key="{fa2ee66e-600a-406c-aa0b-6061b975bb34}" label="Trunk Link">
            <rule filter="(&quot;bridge&quot; IS NULL OR &quot;bridge&quot; IN ('no')) AND (&quot;tunnel&quot; IS NULL OR &quot;tunnel&quot; IN ('no')) AND (&quot;layer&quot; IS NULL OR &quot;layer&quot; &lt;> '-%')" key="{302404c4-8757-44f5-8838-68290fc5ede7}" symbol="64" label="Trunk Link"/>
            <rule filter="&quot;bridge&quot; IS NOT NULL AND &quot;bridge&quot; NOT IN ('no') " key="{3ba7062d-c7ee-4575-a302-f76ab457c7ee}" symbol="65" label="Trunk Link - Bridge"/>
            <rule filter="(&quot;tunnel&quot; IS NOT NULL AND &quot;tunnel&quot; NOT IN ('no')) OR (&quot;layer&quot; IS NOT NULL AND &quot;layer&quot; = '-%')" key="{20934329-9ec8-44e8-af58-206235da41b2}" symbol="66" label="Trunk Link - Tunnel"/>
          </rule>
          <rule description="trunk &amp; primary Link" filter="&quot;highway&quot; IN ('primary')" key="{cceb6099-375b-4d35-af81-e12295803135}" label="Primary">
            <rule key="{bdafc181-728b-428a-bc01-7aaddc6bf07a}" symbol="67" label="Primary"/>
            <rule checkstate="0" filter="(&quot;bridge&quot; IS NULL OR &quot;bridge&quot; IN ('no')) AND (&quot;tunnel&quot; IS NULL OR &quot;tunnel&quot; IN ('no')) AND  (&quot;layer&quot; IS NULL OR  &quot;layer&quot;  >=  '0')" key="{ec3de176-0472-4514-b47f-bd66c2f00691}" symbol="68" label="NO Primary"/>
            <rule checkstate="0" filter="&quot;bridge&quot; IS NOT NULL AND &quot;bridge&quot; NOT IN ('no') " key="{2adb30f9-f1c1-4316-8d1d-963c6618c3e7}" symbol="69" label="NO Primary - Bridge"/>
            <rule checkstate="0" filter="(&quot;tunnel&quot; IS NOT NULL AND &quot;tunnel&quot; NOT IN ('no')) OR &quot;layer&quot; ILIKE '-%'" key="{bedddb0c-275d-4d56-9803-5db73cec4452}" symbol="70" label="NO Primary - Tunnel"/>
          </rule>
          <rule description="trunk &amp; primary Link" filter="&quot;highway&quot; IN ('primary_link')" key="{520cb324-0e4d-4366-bbd1-780ca76218f0}" label="Primary Link">
            <rule key="{49eb05b3-4af5-4acd-9cf8-95056e43b333}" symbol="71" label="Primary Link"/>
            <rule checkstate="0" filter="(&quot;bridge&quot; IS NULL OR &quot;bridge&quot; IN ('no')) AND (&quot;tunnel&quot; IS NULL OR &quot;tunnel&quot; IN ('no')) AND (&quot;layer&quot; IS NULL OR &quot;layer&quot; &lt;> '-%')" key="{f4e8c14d-98e1-4b63-8bee-222e57946367}" symbol="72" label="NO Primary Link"/>
            <rule checkstate="0" filter="&quot;bridge&quot; IS NOT NULL AND &quot;bridge&quot; NOT IN ('no') " key="{8f2f0066-7139-403d-9656-c26c7c7dc54b}" symbol="73" label="NO Primary Link - Bridge"/>
            <rule checkstate="0" filter="(&quot;tunnel&quot; IS NOT NULL AND &quot;tunnel&quot; NOT IN ('no')) OR (&quot;layer&quot; IS NOT NULL AND &quot;layer&quot; = '-%')" key="{6f25df50-745a-4632-abf4-b5585aa0c4f4}" symbol="74" label="NO Primary Link - Tunnel"/>
          </rule>
          <rule description="trunk &amp; primary Link" filter="&quot;highway&quot; IN ('secondary','secondary_link')" key="{c7e9c227-ba2f-41a8-b0b6-9b60c2d85e32}" label="Secondary">
            <rule key="{89be9b57-c653-426a-9ea6-f953f0fcc24b}" symbol="75" label="Secondary"/>
            <rule checkstate="0" filter="(&quot;bridge&quot; IS NULL OR &quot;bridge&quot; IN ('no')) AND (&quot;tunnel&quot; IS NULL OR &quot;tunnel&quot; IN ('no')) AND (&quot;layer&quot; IS NULL OR &quot;layer&quot; &lt;> '-%')" key="{60694c05-fdf3-4298-87b0-c38cd37611a6}" symbol="76" label="NO Secondary"/>
            <rule checkstate="0" filter="&quot;bridge&quot; IS NOT NULL AND &quot;bridge&quot; NOT IN ('no') " key="{c737eb70-ac0a-4ba6-8f86-90968871c22f}" symbol="77" label="NO Secondary - Bridge"/>
            <rule checkstate="0" filter="(&quot;tunnel&quot; IS NOT NULL AND &quot;tunnel&quot; NOT IN ('no')) OR (&quot;layer&quot; IS NOT NULL AND &quot;layer&quot; = '-%')" key="{9dbf4e62-48d5-424a-a864-daacb17f64c6}" symbol="78" label="NO Secondary - Tunnel"/>
          </rule>
          <rule filter="&quot;highway&quot; IN ('tertiary','tertiary_link')" key="{50a3b8b6-9457-4562-9c5c-fb08fa6beb48}" label="Tertiary">
            <rule key="{5fc7412b-8206-461a-bab7-fd171ea4cb9e}" symbol="79" label="Tertiary"/>
            <rule checkstate="0" filter="(&quot;bridge&quot; IS NULL OR &quot;bridge&quot; IN ('no')) AND (&quot;tunnel&quot; IS NULL OR &quot;tunnel&quot; IN ('no')) AND (&quot;layer&quot; IS NULL OR &quot;layer&quot; &lt;> '-%')" key="{0634bc9b-162a-44f5-8b62-ff1e2731713c}" symbol="80" label="NO Tertiary"/>
            <rule checkstate="0" filter="&quot;bridge&quot; IS NOT NULL AND &quot;bridge&quot; NOT IN ('no') " key="{69313d07-dbd8-495a-822d-495968b3b3b5}" symbol="81" label="NO Tertiary - Bridge"/>
            <rule checkstate="0" filter="(&quot;tunnel&quot; IS NOT NULL AND &quot;tunnel&quot; NOT IN ('no')) OR (&quot;layer&quot; IS NOT NULL AND &quot;layer&quot; = '-%')" key="{52aa2fe8-474d-497d-b640-2fe3c4fbc60c}" symbol="82" label="NO Tertiary - Tunnel"/>
          </rule>
          <rule filter="&quot;highway&quot; IN ('residential','road','unclassified')" key="{f21160e7-ab34-40ad-a454-d00ee6d72447}" label="Roads">
            <rule key="{824933c4-322b-4b94-9490-3ca725a69aa5}" symbol="83" label="Roads"/>
            <rule checkstate="0" filter="(&quot;bridge&quot; IS NULL OR &quot;bridge&quot; IN ('no')) AND (&quot;tunnel&quot; IS NULL OR &quot;tunnel&quot; IN ('no')) AND (&quot;layer&quot; IS NULL OR &quot;layer&quot; &lt;> '-%')" key="{ad48ad4d-a996-4199-b9a9-88bbe29f19a8}" symbol="84" label="NO Roads"/>
            <rule checkstate="0" filter="&quot;bridge&quot; IS NOT NULL AND &quot;bridge&quot; NOT IN ('no') " key="{e28149dc-48e8-45e6-a804-6e5655c2b26e}" symbol="85" label="NO Roads - Bridge"/>
            <rule checkstate="0" filter="(&quot;tunnel&quot; IS NOT NULL AND &quot;tunnel&quot; NOT IN ('no')) OR (&quot;layer&quot; IS NOT NULL AND &quot;layer&quot; = '-%')" key="{ccf15db6-76b6-459c-90e9-05d77f2e2161}" symbol="86" label="NO Roads - Tunnel"/>
          </rule>
          <rule checkstate="0" filter="&quot;highway&quot; IN ('service')" key="{d049f715-ee27-4cbd-8905-ddb8deba6075}" label="NO Service">
            <rule filter="(&quot;bridge&quot; IS NULL OR &quot;bridge&quot; IN ('no')) AND (&quot;tunnel&quot; IS NULL OR &quot;tunnel&quot; IN ('no')) AND (&quot;layer&quot; IS NULL OR &quot;layer&quot; &lt;> '-%')" key="{5b888201-ee06-4b28-bbbd-98c64299d818}" symbol="87" label="Service"/>
            <rule filter="&quot;bridge&quot; IS NOT NULL AND &quot;bridge&quot; NOT IN ('no') " key="{25387eb1-8ac2-48fa-a0e2-b5a1cd8a3d88}" symbol="88" label="Service - Bridge"/>
            <rule filter="(&quot;tunnel&quot; IS NOT NULL AND &quot;tunnel&quot; NOT IN ('no')) OR (&quot;layer&quot; IS NOT NULL AND &quot;layer&quot; = '-%')" key="{9a1f2765-69ae-4a52-98b8-396008c75712}" symbol="89" label="Service - Tunnel"/>
          </rule>
          <rule checkstate="0" filter="&quot;highway&quot; IN ('pedestrian')" key="{8870c2ec-6eed-4e54-b7fc-8e8ac2e384ef}" label="NO Pedestrian">
            <rule filter="(&quot;bridge&quot; IS NULL OR &quot;bridge&quot; IN ('no')) AND (&quot;tunnel&quot; IS NULL OR &quot;tunnel&quot; IN ('no')) AND (&quot;layer&quot; IS NULL OR &quot;layer&quot; &lt;> '-%')" key="{e9e1dbf1-6429-4d06-bf2e-297d4021b5d4}" symbol="90" label="Pedestrian"/>
            <rule filter="&quot;bridge&quot; IS NOT NULL AND &quot;bridge&quot; NOT IN ('no') " key="{b676bbaf-c454-47db-bc0a-d537e5f35b2f}" symbol="91" label="Pedestrian - Bridge"/>
            <rule filter="(&quot;tunnel&quot; IS NOT NULL AND &quot;tunnel&quot; NOT IN ('no')) OR (&quot;layer&quot; IS NOT NULL AND &quot;layer&quot; = '-%')" key="{103f51be-efd2-41d8-aebf-9c3b084ca3da}" symbol="92" label="Pedestrian - Tunnel"/>
          </rule>
          <rule checkstate="0" filter="&quot;highway&quot; IN ('living_street')" key="{47173948-27fd-4b81-80e2-5297c1197c4b}" label="NO Living Street">
            <rule filter="(&quot;bridge&quot; IS NULL OR &quot;bridge&quot; IN ('no')) AND (&quot;tunnel&quot; IS NULL OR &quot;tunnel&quot; IN ('no')) AND (&quot;layer&quot; IS NULL OR &quot;layer&quot; &lt;> '-%')" key="{62d63477-0116-46b5-bc94-ea036ddde4cd}" symbol="93" label="Living Street"/>
            <rule filter="&quot;bridge&quot; IS NOT NULL AND &quot;bridge&quot; NOT IN ('no') " key="{7b0c7945-3707-4223-b045-ed58ac1a26bb}" symbol="94" label="Living Street - Bridge"/>
            <rule filter="(&quot;tunnel&quot; IS NOT NULL AND &quot;tunnel&quot; NOT IN ('no')) OR (&quot;layer&quot; IS NOT NULL AND &quot;layer&quot; = '-%')" key="{bb1df753-24fd-4125-88a0-e51568d735b8}" symbol="95" label="Living Street - Tunnel"/>
          </rule>
          <rule checkstate="0" filter=" &quot;highway&quot; IN ('track')" key="{6839a07d-0dd6-4326-8b5c-60c08d6b0ed7}" label="NO Track">
            <rule filter="(&quot;bridge&quot; IS NULL OR &quot;bridge&quot; IN ('no')) AND (&quot;tunnel&quot; IS NULL OR &quot;tunnel&quot; IN ('no')) AND (&quot;layer&quot; IS NULL OR &quot;layer&quot; &lt;> '-%')" key="{e3454002-0f0e-45ad-b3ab-64ceccf32d63}" symbol="96" label="Track"/>
            <rule filter="&quot;bridge&quot; IS NOT NULL AND &quot;bridge&quot; NOT IN ('no') " key="{3eafcd15-150c-45ce-a6c8-916ae4db7fc7}" symbol="97" label="Track"/>
            <rule filter="(&quot;tunnel&quot; IS NOT NULL AND &quot;tunnel&quot; NOT IN ('no')) OR (&quot;layer&quot; IS NOT NULL AND &quot;layer&quot; = '-%')" key="{d0bca78a-1ccc-4edf-9137-3e8a98f31201}" symbol="98" label="Track"/>
          </rule>
        </rule>
        <rule checkstate="0" key="{6ecb3e7b-3614-464c-97d8-8728fe2f80cd}" label="NO Path">
          <rule filter=" &quot;highway&quot; IN ('footway','path')" key="{db1ba00a-c45a-4839-afa5-3026f266f425}" label="Foot">
            <rule filter="(&quot;bridge&quot; IS NULL OR &quot;bridge&quot; IN ('no')) AND (&quot;tunnel&quot; IS NULL OR &quot;tunnel&quot; IN ('no')) AND (&quot;layer&quot; IS NULL OR &quot;layer&quot; &lt;> '-%')" key="{13dd2198-97e0-4d41-8774-97a78c670e10}" symbol="99" label="Foot"/>
            <rule filter="&quot;bridge&quot; IS NOT NULL AND &quot;bridge&quot; NOT IN ('no') " key="{6696c83e-4069-4b56-9581-abd134fea636}" symbol="100" label="Foot - Bridge"/>
            <rule filter="(&quot;tunnel&quot; IS NOT NULL AND &quot;tunnel&quot; NOT IN ('no')) OR (&quot;layer&quot; IS NOT NULL AND &quot;layer&quot; = '-%')" key="{5f3459db-b077-4baf-94b6-6eedfdac3111}" symbol="101" label="Foot - Tunnel"/>
          </rule>
          <rule filter=" &quot;highway&quot;  =  'steps' " key="{b8ef3c9c-d797-4119-a387-a08501bce075}" symbol="102" label="Steps"/>
          <rule filter="&quot;man_made&quot; = 'pier'" key="{7daa3742-381b-4420-bd49-4258b2d16d3c}" symbol="103" label="Pier"/>
        </rule>
        <rule key="{e4361e67-a665-43db-846e-ac8c876b98bc}" label="Rails">
          <rule filter="&quot;railway&quot;  =  'rail' AND  NOT (&quot;tags&quot;  LIKE  '%&quot;usage&quot;=>&quot;industrial&quot;%')" key="{f21265df-0265-478b-8473-3ebd0810449e}" label="Rails">
            <rule filter="(&quot;bridge&quot; IS NULL OR &quot;bridge&quot; IN ('no')) AND (&quot;tunnel&quot; IS NULL OR &quot;tunnel&quot; IN ('no')) AND (&quot;layer&quot; IS NULL OR &quot;layer&quot; &lt;> '-%')" key="{7d8c8cd4-588e-423b-9706-6d33db9ccdcc}" symbol="104" label="Rails"/>
            <rule checkstate="0" filter="(&quot;bridge&quot; IS NULL OR &quot;bridge&quot; IN ('no')) AND (&quot;tunnel&quot; IS NULL OR &quot;tunnel&quot; IN ('no')) AND (&quot;layer&quot; IS NULL OR &quot;layer&quot; &lt;> '-%')" key="{f6651205-f96b-4e1f-8b60-2435fe6a64dc}" symbol="105" label="NO Rails"/>
            <rule checkstate="0" filter="&quot;bridge&quot; IS NOT NULL AND &quot;bridge&quot; NOT IN ('no')" key="{833d45d6-43e3-48b2-8250-f79a37e4fc42}" symbol="106" label="NO Rails - Bridge"/>
            <rule checkstate="0" filter="(&quot;tunnel&quot; IS NOT NULL AND &quot;tunnel&quot; NOT IN ('no')) OR (&quot;layer&quot; IS NOT NULL AND &quot;layer&quot; = '-%')" key="{3be90dca-5e6b-4a4a-b4e2-7d063b915c71}" symbol="107" label="NO Rails - Tunnel"/>
          </rule>
          <rule checkstate="0" filter="&quot;railway&quot;  =  'rail' AND  &quot;tags&quot; ILIKE '%&quot;usage&quot;=>&quot;industrial&quot;%'" key="{f5898d9e-8688-4fa6-8617-e5714add8690}" symbol="108" label="NO Rails industrial"/>
          <rule filter=" &quot;railway&quot;  =  'tram' " key="{ed40d761-11d1-4873-86e8-1d1dd2eeb111}" symbol="109" label="Tram"/>
        </rule>
        <rule checkstate="0" filter="&quot;private&quot;='yes'" key="{14d23d65-2e96-467c-a214-bd911d3f58b6}" symbol="110" label="Private"/>
        <rule filter="&quot;waterway&quot; in ('river')" key="{15782f64-8300-4014-a10a-be5fe86da2d4}" label="River">
          <rule key="{40494404-4e2e-4b0d-b553-c336172e80d4}" symbol="111" label="River"/>
        </rule>
        <rule filter="&quot;waterway&quot; in ('stream')" key="{d1a7130b-72e6-4d56-8c10-6d62b107d998}" label="Stream">
          <rule key="{7fc8b462-6a5a-4436-8c15-395899e40ee1}" symbol="112" label="Stream"/>
        </rule>
        <rule filter="&quot;waterway&quot; in ('canal')" key="{9d5681af-fc52-46bb-a1e6-1c58aa702586}" label="Canal">
          <rule key="{3dc1a363-cc21-4f01-873c-97eb04243d6f}" symbol="113" label="Canal"/>
        </rule>
        <rule checkstate="0" filter="&quot;barrier&quot;='city_wall'" key="{16212093-e93f-462b-87cc-3495f7101b7f}" symbol="114" label="NO City Wall"/>
      </rule>
      <rule scalemaxdenom="600000" checkstate="0" key="{51f35acd-ee2c-4b80-abec-8412fc57414d}" scalemindenom="200000" label="Zoom 200-600K">
        <rule checkstate="0" filter="&quot;highway&quot; is not null" key="{1045ee2e-d697-4a14-a55e-75aaed66a8ec}" label="Roads">
          <rule filter="&quot;highway&quot; IN ('motorway','motorway_link')" key="{24505fea-5c0f-4171-b69a-cad78f93e7de}" label="Motorway">
            <rule filter="(&quot;bridge&quot; IS NULL OR &quot;bridge&quot; IN ('no')) AND (&quot;tunnel&quot; IS NULL OR &quot;tunnel&quot; IN ('no')) AND (&quot;layer&quot; IS NULL OR &quot;layer&quot; &lt;> '-%')" key="{72d524f8-ee15-44b2-ab16-4a5b3937ac0b}" symbol="115" label="Motorway"/>
            <rule filter="&quot;bridge&quot; IS NOT NULL AND &quot;bridge&quot; NOT IN ('no')" key="{d86b81c1-4125-4077-ae22-4f3cd76b4df5}" symbol="116" label="Motorway - Bridge"/>
            <rule filter="(&quot;tunnel&quot; IS NOT NULL AND &quot;tunnel&quot; NOT IN ('no')) OR (&quot;layer&quot; IS NOT NULL AND &quot;layer&quot; = '-%')" key="{3573b041-5b33-4ec0-844d-3cbccdc96bc5}" symbol="117" label="Motorway - Tunnel"/>
          </rule>
          <rule description="trunk &amp; primary" filter="&quot;highway&quot; IN ('trunk')" key="{053f54d0-f905-467e-becf-d84991ee7910}" label="Trunk">
            <rule key="{ad24baa2-296c-45c8-a9c2-b6396c6a99f9}" symbol="118" label="Trunk"/>
            <rule filter="&quot;bridge&quot; IS NOT NULL AND &quot;bridge&quot; NOT IN ('no') " key="{ca410054-241f-4c15-86c3-66dd28f0b8ab}" symbol="119" label="Trunk - Bridge"/>
            <rule checkstate="0" filter="(&quot;bridge&quot; IS NULL OR &quot;bridge&quot; IN ('no')) AND (&quot;tunnel&quot; IS NULL OR &quot;tunnel&quot; IN ('no')) AND (&quot;layer&quot; IS NULL OR &quot;layer&quot; &lt;> '-%')" key="{57152a0d-3825-4408-9969-07c5d3c926d6}" symbol="120" label="NO Trunk"/>
            <rule checkstate="0" filter="&quot;bridge&quot; IS NOT NULL AND &quot;bridge&quot; NOT IN ('no') " key="{59e78e05-f21b-4314-acf2-367dfc877cfc}" symbol="121" label="NO Trunk - Bridge"/>
            <rule checkstate="0" filter="(&quot;tunnel&quot; IS NOT NULL AND &quot;tunnel&quot; NOT IN ('no')) OR (&quot;layer&quot; IS NOT NULL AND &quot;layer&quot; = '-%')" key="{1530070b-6d88-47bf-a786-9931666cfe2f}" symbol="122" label="NO Trunk - Tunnel"/>
          </rule>
          <rule description="trunk &amp; primary" filter="&quot;highway&quot; IN ('trunk_link')" key="{278adee6-2813-4b38-8f31-238d35450415}" label="Trunk Link">
            <rule key="{622d3e90-2f64-48d6-afe1-74e9159e098d}" symbol="123" label="Trunk Link"/>
            <rule filter="&quot;bridge&quot; IS NOT NULL AND &quot;bridge&quot; NOT IN ('no')" key="{06fa7f53-1149-4cc8-8fcb-57028af5645e}" symbol="124" label="Trunk Link - Bridge"/>
            <rule checkstate="0" filter="(&quot;bridge&quot; IS NULL OR &quot;bridge&quot; IN ('no')) AND (&quot;tunnel&quot; IS NULL OR &quot;tunnel&quot; IN ('no')) AND (&quot;layer&quot; IS NULL OR &quot;layer&quot; &lt;> '-%')" key="{33ef1973-b9b1-4ef5-ad64-3336af1571f2}" symbol="125" label="NO Trunk Link"/>
            <rule checkstate="0" filter="(&quot;tunnel&quot; IS NOT NULL AND &quot;tunnel&quot; NOT IN ('no')) OR (&quot;layer&quot; IS NOT NULL AND &quot;layer&quot; = '-%')" key="{ad89791d-139e-45fe-875e-24615306bc19}" symbol="126" label="NO Trunk Link - Tunnel"/>
          </rule>
          <rule description="trunk &amp; primary Link" filter="&quot;highway&quot; IN ('primary')" key="{d4fdec31-d54d-4bc6-a1e1-cca46ef3c5dc}" label="Primary">
            <rule key="{d4388f25-f7e7-440b-af2f-6f206e430c1d}" symbol="127" label="Primary"/>
            <rule filter="&quot;bridge&quot; IS NOT NULL AND &quot;bridge&quot; NOT IN ('no') " key="{fef8ccbc-b8b5-4936-a3ed-3ea44e8c4434}" symbol="128" label="Primary - Bridge"/>
            <rule checkstate="0" filter="(&quot;bridge&quot; IS NULL OR &quot;bridge&quot; IN ('no')) AND (&quot;tunnel&quot; IS NULL OR &quot;tunnel&quot; IN ('no')) AND  (&quot;layer&quot; IS NULL OR  &quot;layer&quot;  >=  '0')" key="{f54bd50c-eb96-44f7-a223-f508b129f0d3}" symbol="129" label="NO Primary"/>
            <rule checkstate="0" filter="&quot;bridge&quot; IS NOT NULL AND &quot;bridge&quot; NOT IN ('no') " key="{cbb9d6aa-c500-475e-80a6-57e5ef533c73}" symbol="130" label="NO Primary - Bridge"/>
            <rule checkstate="0" filter="(&quot;tunnel&quot; IS NOT NULL AND &quot;tunnel&quot; NOT IN ('no')) OR &quot;layer&quot; ILIKE '-%'" key="{7e1877dc-419b-43b9-bb3d-562661db8af2}" symbol="131" label="NO Primary - Tunnel"/>
          </rule>
          <rule description="trunk &amp; primary Link" filter="&quot;highway&quot; IN ('primary_link')" key="{54f87893-e7ad-48a0-954a-e91bbcb3ff42}" label="Primary Link">
            <rule key="{b67ccfe5-bbef-44fa-b3e5-e3bd7e040d12}" symbol="132" label="Primary Link"/>
            <rule filter="&quot;bridge&quot; IS NOT NULL AND &quot;bridge&quot; NOT IN ('no') " key="{9e40e564-9881-4be7-80d0-08b8964efb5e}" symbol="133" label="Primary Link - Bridge"/>
            <rule checkstate="0" filter="(&quot;bridge&quot; IS NULL OR &quot;bridge&quot; IN ('no')) AND (&quot;tunnel&quot; IS NULL OR &quot;tunnel&quot; IN ('no')) AND (&quot;layer&quot; IS NULL OR &quot;layer&quot; &lt;> '-%')" key="{0dba2913-c472-4aea-8c96-e8e2f1b4a721}" symbol="134" label="NO Primary Link"/>
            <rule checkstate="0" filter="&quot;bridge&quot; IS NOT NULL AND &quot;bridge&quot; NOT IN ('no') " key="{915bdfbd-0e80-4dee-ad14-f94d0b5bcb7a}" symbol="135" label="NO Primary Link - Bridge"/>
            <rule checkstate="0" filter="(&quot;tunnel&quot; IS NOT NULL AND &quot;tunnel&quot; NOT IN ('no')) OR (&quot;layer&quot; IS NOT NULL AND &quot;layer&quot; = '-%')" key="{fbce0a28-3029-4e71-b1e3-87ddee9c143b}" symbol="136" label="NO Primary Link - Tunnel"/>
          </rule>
          <rule description="trunk &amp; primary Link" filter="&quot;highway&quot; IN ('secondary','secondary_link')" key="{32f12530-f644-44be-ba2f-fbca407c5544}" label="Secondary">
            <rule key="{69d29d62-030e-4c4b-890e-a24be278f57d}" symbol="137" label="Secondary"/>
            <rule checkstate="0" filter="(&quot;bridge&quot; IS NULL OR &quot;bridge&quot; IN ('no')) AND (&quot;tunnel&quot; IS NULL OR &quot;tunnel&quot; IN ('no')) AND (&quot;layer&quot; IS NULL OR &quot;layer&quot; &lt;> '-%')" key="{9a97eb1b-f1d4-4aef-8d18-0ca79b6916ba}" symbol="138" label="NO Secondary"/>
            <rule checkstate="0" filter="&quot;bridge&quot; IS NOT NULL AND &quot;bridge&quot; NOT IN ('no') " key="{211b5847-2607-4749-a44c-1c3cf8a5e93a}" symbol="139" label="NO Secondary - Bridge"/>
            <rule checkstate="0" filter="(&quot;tunnel&quot; IS NOT NULL AND &quot;tunnel&quot; NOT IN ('no')) OR (&quot;layer&quot; IS NOT NULL AND &quot;layer&quot; = '-%')" key="{cd6d9b60-f606-4ddd-af68-5496a4e7bd24}" symbol="140" label="NO Secondary - Tunnel"/>
          </rule>
          <rule filter="&quot;highway&quot; IN ('tertiary','tertiary_link')" key="{c496cf11-49ce-44c3-b44d-65f55ed3b9cb}" label="Tertiary">
            <rule key="{635c6142-6c3d-4521-95d4-a3a360493665}" symbol="141" label="Tertiary"/>
            <rule checkstate="0" filter="(&quot;bridge&quot; IS NULL OR &quot;bridge&quot; IN ('no')) AND (&quot;tunnel&quot; IS NULL OR &quot;tunnel&quot; IN ('no')) AND (&quot;layer&quot; IS NULL OR &quot;layer&quot; &lt;> '-%')" key="{5080d79c-e169-4e5c-8a94-c94ea4a1dad4}" symbol="142" label="NO Tertiary"/>
            <rule checkstate="0" filter="&quot;bridge&quot; IS NOT NULL AND &quot;bridge&quot; NOT IN ('no') " key="{864bd80d-08a9-4f76-9a09-62e6eec7263a}" symbol="143" label="NO Tertiary - Bridge"/>
            <rule checkstate="0" filter="(&quot;tunnel&quot; IS NOT NULL AND &quot;tunnel&quot; NOT IN ('no')) OR (&quot;layer&quot; IS NOT NULL AND &quot;layer&quot; = '-%')" key="{9e9119e0-fc64-43f5-b360-ade2c20d167e}" symbol="144" label="NO Tertiary - Tunnel"/>
          </rule>
          <rule checkstate="0" filter="&quot;highway&quot; IN ('residential','road','unclassified')" key="{528e73a0-50b5-4634-b7d8-a19829a177db}" label="NO Roads">
            <rule checkstate="0" key="{d3521ba7-a039-47f4-901e-32b05ad6b81d}" symbol="145" label="NO Roads"/>
            <rule checkstate="0" filter="(&quot;bridge&quot; IS NULL OR &quot;bridge&quot; IN ('no')) AND (&quot;tunnel&quot; IS NULL OR &quot;tunnel&quot; IN ('no')) AND (&quot;layer&quot; IS NULL OR &quot;layer&quot; &lt;> '-%')" key="{60f94953-67f3-46e9-8fa0-a3b78dfe176f}" symbol="146" label="NO Roads"/>
            <rule checkstate="0" filter="&quot;bridge&quot; IS NOT NULL AND &quot;bridge&quot; NOT IN ('no') " key="{4b628fdd-8278-4074-b95a-d00f6dbf3d28}" symbol="147" label="NO Roads - Bridge"/>
            <rule checkstate="0" filter="(&quot;tunnel&quot; IS NOT NULL AND &quot;tunnel&quot; NOT IN ('no')) OR (&quot;layer&quot; IS NOT NULL AND &quot;layer&quot; = '-%')" key="{3685a482-c5a0-44f3-9101-074c2d33e84c}" symbol="148" label="NO Roads - Tunnel"/>
          </rule>
          <rule checkstate="0" filter="&quot;highway&quot; IN ('service')" key="{516ef186-abef-4d00-9315-43749be6dd9b}" label="NO Service">
            <rule filter="(&quot;bridge&quot; IS NULL OR &quot;bridge&quot; IN ('no')) AND (&quot;tunnel&quot; IS NULL OR &quot;tunnel&quot; IN ('no')) AND (&quot;layer&quot; IS NULL OR &quot;layer&quot; &lt;> '-%')" key="{b70d324a-9dd7-4985-92cc-7a3577daddbf}" symbol="149" label="Service"/>
            <rule filter="&quot;bridge&quot; IS NOT NULL AND &quot;bridge&quot; NOT IN ('no') " key="{fa81f088-0d33-42ac-9662-9c901d04395d}" symbol="150" label="Service - Bridge"/>
            <rule filter="(&quot;tunnel&quot; IS NOT NULL AND &quot;tunnel&quot; NOT IN ('no')) OR (&quot;layer&quot; IS NOT NULL AND &quot;layer&quot; = '-%')" key="{7f4808e4-26ac-4729-81d2-1be9e4653382}" symbol="151" label="Service - Tunnel"/>
          </rule>
          <rule checkstate="0" filter="&quot;highway&quot; IN ('pedestrian')" key="{ed5713c8-d5b3-465b-a735-2e1ac7c18413}" label="NO Pedestrian">
            <rule filter="(&quot;bridge&quot; IS NULL OR &quot;bridge&quot; IN ('no')) AND (&quot;tunnel&quot; IS NULL OR &quot;tunnel&quot; IN ('no')) AND (&quot;layer&quot; IS NULL OR &quot;layer&quot; &lt;> '-%')" key="{fe8dd7de-37ce-4a6c-b5c2-1d616ad62941}" symbol="152" label="Pedestrian"/>
            <rule filter="&quot;bridge&quot; IS NOT NULL AND &quot;bridge&quot; NOT IN ('no') " key="{dfec072e-d733-4bdf-b762-844bc6292fce}" symbol="153" label="Pedestrian - Bridge"/>
            <rule filter="(&quot;tunnel&quot; IS NOT NULL AND &quot;tunnel&quot; NOT IN ('no')) OR (&quot;layer&quot; IS NOT NULL AND &quot;layer&quot; = '-%')" key="{d227c10f-f734-4bf0-a305-5c48a5b9f799}" symbol="154" label="Pedestrian - Tunnel"/>
          </rule>
          <rule checkstate="0" filter="&quot;highway&quot; IN ('living_street')" key="{779b2de5-df97-4df4-9fe8-f50deeef5b31}" label="NO Living Street">
            <rule filter="(&quot;bridge&quot; IS NULL OR &quot;bridge&quot; IN ('no')) AND (&quot;tunnel&quot; IS NULL OR &quot;tunnel&quot; IN ('no')) AND (&quot;layer&quot; IS NULL OR &quot;layer&quot; &lt;> '-%')" key="{c4aed0ad-3457-40c0-aade-4c4d0876da5b}" symbol="155" label="Living Street"/>
            <rule filter="&quot;bridge&quot; IS NOT NULL AND &quot;bridge&quot; NOT IN ('no') " key="{53c09fbd-c617-43d1-b704-4eb0efa99ba7}" symbol="156" label="Living Street - Bridge"/>
            <rule filter="(&quot;tunnel&quot; IS NOT NULL AND &quot;tunnel&quot; NOT IN ('no')) OR (&quot;layer&quot; IS NOT NULL AND &quot;layer&quot; = '-%')" key="{b1c485a3-b44a-4c7f-a6f3-873959b38693}" symbol="157" label="Living Street - Tunnel"/>
          </rule>
          <rule checkstate="0" filter=" &quot;highway&quot; IN ('track')" key="{8ebb7551-5222-4bf6-8d2a-c36199f518fd}" label="NO Track">
            <rule filter="(&quot;bridge&quot; IS NULL OR &quot;bridge&quot; IN ('no')) AND (&quot;tunnel&quot; IS NULL OR &quot;tunnel&quot; IN ('no')) AND (&quot;layer&quot; IS NULL OR &quot;layer&quot; &lt;> '-%')" key="{1218c83f-07c9-42b0-8901-a207273a40e0}" symbol="158" label="Track"/>
            <rule filter="&quot;bridge&quot; IS NOT NULL AND &quot;bridge&quot; NOT IN ('no') " key="{9a40378e-f4f2-46a3-887f-b2c5790fd8bd}" symbol="159" label="Track"/>
            <rule filter="(&quot;tunnel&quot; IS NOT NULL AND &quot;tunnel&quot; NOT IN ('no')) OR (&quot;layer&quot; IS NOT NULL AND &quot;layer&quot; = '-%')" key="{d3873cc2-a7d5-4233-8b1a-fd4574d1856b}" symbol="160" label="Track"/>
          </rule>
        </rule>
        <rule checkstate="0" key="{dcf2c8d8-1859-49c2-aa62-44d0a91fe71c}" label="NO Path">
          <rule filter=" &quot;highway&quot; IN ('footway','path')" key="{35238fbb-6f72-407b-86ad-e675e8a1bd65}" label="Foot">
            <rule filter="(&quot;bridge&quot; IS NULL OR &quot;bridge&quot; IN ('no')) AND (&quot;tunnel&quot; IS NULL OR &quot;tunnel&quot; IN ('no')) AND (&quot;layer&quot; IS NULL OR &quot;layer&quot; &lt;> '-%')" key="{ca186392-4f6f-492a-be00-b779ee363496}" symbol="161" label="Foot"/>
            <rule filter="&quot;bridge&quot; IS NOT NULL AND &quot;bridge&quot; NOT IN ('no') " key="{40ae13db-ebc2-49c2-b7f8-a43dba5e949a}" symbol="162" label="Foot - Bridge"/>
            <rule filter="(&quot;tunnel&quot; IS NOT NULL AND &quot;tunnel&quot; NOT IN ('no')) OR (&quot;layer&quot; IS NOT NULL AND &quot;layer&quot; = '-%')" key="{51918ac0-4caa-46b1-bbd6-644645113929}" symbol="163" label="Foot - Tunnel"/>
          </rule>
          <rule filter=" &quot;highway&quot;  =  'steps' " key="{1e765f7d-04c1-4789-9dd8-ee2dde2cce03}" symbol="164" label="Steps"/>
          <rule filter="&quot;man_made&quot; = 'pier'" key="{b7e40af3-c3f8-4aed-bc71-bff6ab70eaf4}" symbol="165" label="Pier"/>
        </rule>
        <rule key="{90e08f14-da5f-42ed-b369-262975b9646b}" label="Rails">
          <rule filter="&quot;railway&quot;  =  'rail' AND  NOT (&quot;tags&quot;  LIKE  '%&quot;usage&quot;=>&quot;industrial&quot;%')" key="{f1de04bb-c812-49b7-819b-4a2129290fef}" label="Rails">
            <rule filter="(&quot;bridge&quot; IS NULL OR &quot;bridge&quot; IN ('no')) AND (&quot;tunnel&quot; IS NULL OR &quot;tunnel&quot; IN ('no')) AND (&quot;layer&quot; IS NULL OR &quot;layer&quot; &lt;> '-%')" key="{54ca635d-a04e-49e4-83e6-6fb6d8e405f9}" symbol="166" label="Rails"/>
            <rule checkstate="0" filter="(&quot;bridge&quot; IS NULL OR &quot;bridge&quot; IN ('no')) AND (&quot;tunnel&quot; IS NULL OR &quot;tunnel&quot; IN ('no')) AND (&quot;layer&quot; IS NULL OR &quot;layer&quot; &lt;> '-%')" key="{0faa5625-c832-4c75-af92-fb9e76ac2b88}" symbol="167" label="NO Rails"/>
            <rule checkstate="0" filter="&quot;bridge&quot; IS NOT NULL AND &quot;bridge&quot; NOT IN ('no')" key="{f665c702-75b3-4311-9118-22a17fe37ebc}" symbol="168" label="NO Rails - Bridge"/>
            <rule checkstate="0" filter="(&quot;tunnel&quot; IS NOT NULL AND &quot;tunnel&quot; NOT IN ('no')) OR (&quot;layer&quot; IS NOT NULL AND &quot;layer&quot; = '-%')" key="{28a7b42c-6e90-4144-abaa-af31de5b8eae}" symbol="169" label="NO Rails - Tunnel"/>
          </rule>
          <rule checkstate="0" filter="&quot;railway&quot;  =  'rail' AND  &quot;tags&quot; ILIKE '%&quot;usage&quot;=>&quot;industrial&quot;%'" key="{d436cf41-36f1-49e2-a0e6-7bbe373cadd8}" symbol="170" label="NO Rails industrial"/>
          <rule filter=" &quot;railway&quot;  =  'tram' " key="{039d80d8-1aca-4ddd-85df-e30b36bc4930}" symbol="171" label="Tram"/>
        </rule>
        <rule filter="&quot;private&quot;='yes'" key="{ef38c5f3-2248-443b-9170-7c04831b1b4d}" symbol="172" label="Private"/>
        <rule filter="&quot;waterway&quot; in ('river','stream','canal')" key="{9abc377e-226a-411c-9a80-be1a64b83137}" label="River, Streal, Canal">
          <rule key="{249bff87-9984-40eb-92a5-9778225a3f76}" symbol="173" label="River, Streal, Canal"/>
        </rule>
        <rule checkstate="0" filter="&quot;barrier&quot;='city_wall'" key="{84fdd7c4-80b6-4aee-a14b-e6425406c825}" symbol="174" label="NO City Wall"/>
      </rule>
    </rules>
    <symbols>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="102">
        <layer pass="118" class="SimpleLine" locked="0">
          ...
          <prop k="use_custom_dash" v="0"/>
          <prop k="width_dd_active" v="1"/>
          <prop k="width_dd_expression" v="CASE&#xa;  WHEN  $scale &lt;40000 THEN 1&#xa;  WHEN $scale  >= 40000 THEN 0.2&#xa;END"/>
          <prop k="width_dd_field" v=""/>
          <prop k="width_dd_useexpr" v="1"/>
          <prop k="width_map_unit_scale" v="0,0,0,0,0,0"/>
        </layer>
        <layer pass="148" class="MarkerLine" locked="0">
          ...
          <prop k="rotate" v="1"/>
          <symbol alpha="1" clip_to_extent="1" type="marker" name="@102@1">
      ...
      <symbol alpha="0.490196" clip_to_extent="1" type="line" name="117">
      ...
      <symbol alpha="0.498039" clip_to_extent="1" type="line" name="122">
      ...
      <symbol alpha="0.490196" clip_to_extent="1" type="line" name="126">
        <layer pass="0" class="SimpleLine" locked="1">
          <prop k="capstyle" v="square"/>
          <prop k="customdash" v="5;2"/>
          <prop k="customdash_map_unit_scale" v="0,0,0,0,0,0"/>
      ...
      <symbol alpha="0.490196" clip_to_extent="1" type="line" name="136">
        <layer pass="2" class="SimpleLine" locked="1">
          <prop k="capstyle" v="square"/>
          <prop k="customdash" v="5;2"/>
          <prop k="customdash_map_unit_scale" v="0,0,0,0,0,0"/>
      ...
      <symbol alpha="0.498039" clip_to_extent="1" type="line" name="140">
        <layer pass="2" class="SimpleLine" locked="1">
          <prop k="capstyle" v="square"/>
          <prop k="customdash" v="5;2"/>
          <prop k="customdash_map_unit_scale" v="0,0,0,0,0,0"/>
      ...
      <symbol alpha="0.490196" clip_to_extent="1" type="line" name="148">
        <layer pass="4" class="SimpleLine" locked="1">
          <prop k="capstyle" v="flat"/>
          <prop k="customdash" v="5;2"/>
          <prop k="customdash_map_unit_scale" v="0,0,0,0,0,0"/>
      ...
      <symbol alpha="0.490196" clip_to_extent="1" type="line" name="151">
        <layer pass="4" class="SimpleLine" locked="1">
          <prop k="capstyle" v="flat"/>
          <prop k="customdash" v="5;2"/>
          <prop k="customdash_map_unit_scale" v="0,0,0,0,0,0"/>
      ...
      <symbol alpha="0.243137" clip_to_extent="1" type="line" name="154">
        <layer pass="4" class="SimpleLine" locked="1">
          <prop k="capstyle" v="flat"/>
          <prop k="customdash" v="5;2"/>
          <prop k="customdash_map_unit_scale" v="0,0,0,0,0,0"/>
      ...
      <symbol alpha="0.243137" clip_to_extent="1" type="line" name="157">
        <layer pass="4" class="SimpleLine" locked="1">
          <prop k="capstyle" v="flat"/>
          <prop k="customdash" v="5;2"/>
          <prop k="customdash_map_unit_scale" v="0,0,0,0,0,0"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="164">
        ...
        <layer pass="148" class="MarkerLine" locked="0">
          ...
          <prop k="placement" v="interval"/>
          <prop k="rotate" v="1"/>
          <symbol alpha="1" clip_to_extent="1" type="marker" name="@164@1">
            <layer pass="0" class="EllipseMarker" locked="0">
              <prop k="angle" v="0"/>
              <prop k="color" v="255,126,126,255"/>
              <prop k="horizontal_anchor_point" v="1"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="168">
        <layer pass="349" class="SimpleLine" locked="0">
          <prop k="capstyle" v="flat"/>
          <prop k="customdash" v="5;2"/>
          <prop k="customdash_map_unit_scale" v="0,0,0,0,0,0"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="171">
        <layer pass="200" class="SimpleLine" locked="0">
          <prop k="capstyle" v="square"/>
          <prop k="customdash" v="5;2"/>
          <prop k="customdash_map_unit_scale" v="0,0,0,0,0,0"/>
      ...
      <symbol alpha="0.243137" clip_to_extent="1" type="line" name="172">
        <layer pass="0" class="SimpleLine" locked="0">
          <prop k="capstyle" v="round"/>
          <prop k="customdash" v="2;2"/>
          <prop k="customdash_map_unit_scale" v="0,0,0,0,0,0"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="173">
        <layer pass="0" class="SimpleLine" locked="0">
          <prop k="capstyle" v="round"/>
          <prop k="customdash" v="5;2"/>
          <prop k="customdash_map_unit_scale" v="0,0,0,0,0,0"/>
      ...
      <symbol alpha="1" clip_to_extent="1" type="line" name="174">
        <layer pass="0" class="SimpleLine" locked="0">
          <prop k="capstyle" v="square"/>
          <prop k="customdash" v="5;2"/>
          <prop k="customdash_map_unit_scale" v="0,0,0,0,0,0"/>
      ...
      <symbol alpha="0.490196" clip_to_extent="1" type="line" name="60">
        <layer pass="2" class="SimpleLine" locked="0">
          <prop k="capstyle" v="flat"/>
          <prop k="customdash" v="5;2"/>
          <prop k="customdash_map_unit_scale" v="0,0,0,0,0,0"/>
      ...
      <symbol alpha="0.498039" clip_to_extent="1" type="line" name="63">
        <layer pass="2" class="SimpleLine" locked="1">
          <prop k="capstyle" v="square"/>
          <prop k="customdash" v="5;2"/>
          <prop k="customdash_map_unit_scale" v="0,0,0,0,0,0"/>
      ...
      <symbol alpha="0.490196" clip_to_extent="1" type="line" name="66">
        <layer pass="0" class="SimpleLine" locked="1">
          <prop k="capstyle" v="square"/>
          <prop k="customdash" v="5;2"/>
          <prop k="customdash_map_unit_scale" v="0,0,0,0,0,0"/>
      ...
      <symbol alpha="0.498039" clip_to_extent="1" type="line" name="70">
        <layer pass="2" class="SimpleLine" locked="1">
          <prop k="capstyle" v="square"/>
          <prop k="customdash" v="5;2"/>
          <prop k="customdash_map_unit_scale" v="0,0,0,0,0,0"/>
      ...
      <symbol alpha="0.490196" clip_to_extent="1" type="line" name="74">
        <layer pass="2" class="SimpleLine" locked="1">
          <prop k="capstyle" v="square"/>
          <prop k="customdash" v="5;2"/>
          <prop k="customdash_map_unit_scale" v="0,0,0,0,0,0"/>
      ...
      <symbol alpha="0.498039" clip_to_extent="1" type="line" name="78">
        <layer pass="2" class="SimpleLine" locked="1">
          <prop k="capstyle" v="square"/>
          <prop k="customdash" v="5;2"/>
          <prop k="customdash_map_unit_scale" v="0,0,0,0,0,0"/>
      ...
      <symbol alpha="0.490196" clip_to_extent="1" type="line" name="82">
        <layer pass="4" class="SimpleLine" locked="1">
          <prop k="capstyle" v="flat"/>
          <prop k="customdash" v="5;2"/>
          <prop k="customdash_map_unit_scale" v="0,0,0,0,0,0"/>
      ...
      <symbol alpha="0.490196" clip_to_extent="1" type="line" name="86">
        <layer pass="4" class="SimpleLine" locked="1">
          <prop k="capstyle" v="flat"/>
          <prop k="customdash" v="5;2"/>
          <prop k="customdash_map_unit_scale" v="0,0,0,0,0,0"/>
      ...
      <symbol alpha="0.243137" clip_to_extent="1" type="line" name="92">
        <layer pass="4" class="SimpleLine" locked="1">
          <prop k="capstyle" v="flat"/>
          <prop k="customdash" v="5;2"/>
          <prop k="customdash_map_unit_scale" v="0,0,0,0,0,0"/>
      ...
      <symbol alpha="0.243137" clip_to_extent="1" type="line" name="95">
        <layer pass="4" class="SimpleLine" locked="1">
          <prop k="capstyle" v="flat"/>
          <prop k="customdash" v="5;2"/>
          <prop k="customdash_map_unit_scale" v="0,0,0,0,0,0"/>
  ...
  <labeling type="rule-based">
    <rules key="{ef11ace4-e135-4f1f-a0b4-fc9f3595ee60}">
      <rule scalemaxdenom="10000" description="Zoom 16" key="{b1fffaa7-6010-4453-be2b-d2c757b9c46c}" scalemindenom="1">
        <rule description="Pedestrian" filter="&quot;highway&quot; IN ('pedestrian')" key="{f95bc5ee-ecf1-4c4d-8008-6a9460d5be40}">
          <settings>
        ...
        <rule description="Roads" filter="&quot;highway&quot; IN ('residential','road','unclassified')" key="{ccb50b89-8e7e-41ec-9b39-b930f8e96ae6}">
          <settings>
        ...
        <rule description="Tertiary" filter="&quot;highway&quot; IN ('tertiary')" key="{5d4fc3b3-0edd-4d11-b3e9-6301b5a9a1d2}">
          <settings>
            <text-style fontItalic="0" fontFamily="Noto Sans" fontLetterSpacing="0" fontUnderline="0" fontWeight="50" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="42,42,42,255" fontSizeInMapUnits="0" isExpression="1" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="6.5" fieldName="replace(replace(replace(replace(replace(&quot;name&quot;,'Impasse','Imp.'),'Place','Pl.'),'Boulevard','Bd'),'Avenue','Av.'),'Saint','St')" namedStyle="Condensed" fontWordSpacing="0" useSubstitutions="0">
              <substitutions/>
            </text-style>
        ...
        <rule description="Secondary" filter="&quot;highway&quot; IN ('secondary')" key="{0ce34979-3940-4130-9d1c-decc7910dc79}">
          <settings>
        ...
        <rule description="Primary" filter="&quot;highway&quot; IN ('primary')" key="{4be5e0eb-9d4e-4168-b1b1-fbb2194f4fc8}">
          <settings>
        ...
        <rule description="Trunk" filter="&quot;highway&quot; IN ('trunk')" key="{4008bfd1-6267-4641-8f15-3636734366a8}">
          <settings>
            <text-style fontItalic="0" fontFamily="Noto Sans" fontLetterSpacing="0" fontUnderline="0" fontWeight="50" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="1" textColor="42,42,42,255" fontSizeInMapUnits="0" isExpression="1" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="7" fieldName="replace(replace(replace(replace(replace(&quot;name&quot;,'Impasse','Imp.'),'Place','Pl.'),'Boulevard','Bd'),'Avenue','Av.'),'Saint','St')" namedStyle="Condensed" fontWordSpacing="0" useSubstitutions="0">
              <substitutions/>
            </text-style>
      ...
      <rule scalemaxdenom="20000" description="Zoom 15" key="{5e53a17f-63ab-4bb0-ab99-fcf7a810c24c}" scalemindenom="10000">
        <rule description="Pedestrian" filter="&quot;highway&quot; IN ('pedestrian')" key="{03abc86c-0481-4621-bde7-b7d8155c6f64}">
          <settings>
        ...
        <rule description="Roads" filter="&quot;highway&quot; IN ('residential','road','unclassified')" key="{668dcfca-0775-4aef-9727-fdd86ec7f276}">
          <settings>
        ...
        <rule description="Tertiary" filter="&quot;highway&quot; IN ('tertiary')" key="{d6203461-e67c-44eb-875b-be75a6267be6}">
          <settings>
            <text-style fontItalic="0" fontFamily="Noto Sans" fontLetterSpacing="0" fontUnderline="0" fontWeight="50" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="42,42,42,255" fontSizeInMapUnits="0" isExpression="1" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="6" fieldName="replace(replace(replace(replace(replace(&quot;name&quot;,'Impasse','Imp.'),'Place','Pl.'),'Boulevard','Bd'),'Avenue','Av.'),'Saint','St')" namedStyle="Condensed" fontWordSpacing="0" useSubstitutions="0">
              <substitutions/>
            </text-style>
        ...
        <rule description="Secondary" filter="&quot;highway&quot; IN ('secondary')" key="{0ce3b3e2-06a0-458b-a8cb-b989844e0a1a}">
          <settings>
            <text-style fontItalic="0" fontFamily="Noto Sans" fontLetterSpacing="0" fontUnderline="0" fontWeight="50" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="42,42,42,255" fontSizeInMapUnits="0" isExpression="1" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="6" fieldName="replace(replace(replace(replace(replace(&quot;name&quot;,'Impasse','Imp.'),'Place','Pl.'),'Boulevard','Bd'),'Avenue','Av.'),'Saint','St')" namedStyle="Condensed" fontWordSpacing="0" useSubstitutions="0">
              <substitutions/>
            </text-style>
        ...
        <rule description="Primary" filter="&quot;highway&quot; IN ('primary')" key="{344e108d-f452-42c2-8ebb-a9b062b835f5}">
          <settings>
        ...
        <rule description="Trunk" filter="&quot;highway&quot; IN ('trunk')" key="{ff49281a-3357-4c32-a9d3-b533d151d0b6}">
          <settings>
      ...
      <rule scalemaxdenom="40000" description="Zoom 14" key="{534cd9c1-9095-45d5-8277-7e7b7cb59f45}" scalemindenom="20000">
        <rule description="Motorway" filter="&quot;highway&quot; IN ('motorway') AND &quot;bridge&quot; IS NULL" key="{127f588f-b3a5-4381-b95a-90bdb9ba1c93}">
          <settings>
        ...
        <rule description="Trunk" filter="&quot;highway&quot; IN ('trunk')" key="{b37b1ed5-27ad-4a1e-9f1c-edc330451cea}">
          <settings>
        ...
        <rule description="Primary" filter="&quot;highway&quot; IN ('primary')" key="{cd58152e-b4d8-4266-b18e-8306ecfdffa7}">
          <settings>
        ...
        <rule description="Secondary" filter="&quot;highway&quot; IN ('secondary')" key="{ac26d052-0381-4413-83c9-49755fb03b09}">
          <settings>
        ...
        <rule description="Tertiary" filter="&quot;highway&quot; IN ('tertiary')" key="{1592ef18-dfc5-4064-8b0f-ab8020da9ec4}">
          <settings>
      ...
      <rule scalemaxdenom="80000" description="Zoom 13" key="{02a53dde-8f16-4c87-8006-7d46e7128132}" scalemindenom="40000">
        <rule description="Motorway" filter="&quot;highway&quot; IN ('motorway')" key="{d8be91af-0be9-4ac1-b641-33f1fdb9931c}">
          <settings>
            <text-style fontItalic="0" fontFamily="Noto Sans" fontLetterSpacing="0" fontUnderline="0" fontWeight="50" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="131,56,81,255" fontSizeInMapUnits="0" isExpression="0" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="6" fieldName="ref" namedStyle="Condensed" fontWordSpacing="0" useSubstitutions="0">
              <substitutions/>
            </text-style>
        ...
        <rule description="Trunk" filter="&quot;highway&quot; IN ('trunk')" key="{b302bba4-5811-4272-8f58-a8375f658dad}">
          <settings>
            <text-style fontItalic="0" fontFamily="Noto Sans" fontLetterSpacing="0" fontUnderline="0" fontWeight="50" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="112,51,36,255" fontSizeInMapUnits="0" isExpression="0" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="6" fieldName="ref" namedStyle="Condensed" fontWordSpacing="0" useSubstitutions="0">
              <substitutions/>
            </text-style>
        ...
        <rule description="Primary" filter="&quot;highway&quot; IN ('primary')" key="{f71773e5-bf73-42d4-926a-1b4664e13198}">
          <settings>
            <text-style fontItalic="0" fontFamily="Noto Sans" fontLetterSpacing="0" fontUnderline="0" fontWeight="50" fontStrikeout="0" textTransp="0" previewBkgrdColor="#ffffff" fontCapitals="0" textColor="107,80,38,255" fontSizeInMapUnits="0" isExpression="0" blendMode="0" fontSizeMapUnitScale="0,0,0,0,0,0" fontSize="6" fieldName="ref" namedStyle="Condensed" fontWordSpacing="0" useSubstitutions="0">
              <substitutions/>
            </text-style>
        ...
        <rule description="Secondary" filter="&quot;highway&quot; IN ('secondary')" key="{8edf7056-f159-45b9-ad0c-9cd490c1b8f0}">
          <settings>
        ...
        <rule description="Tertiary" filter="&quot;highway&quot; IN ('tertiary')" key="{71cb2ce6-79b4-43b0-92cb-4bf79afa9569}">
          <settings>
  ...
  <aliases>
    ...
    <alias field="bicycle" index="10" name=""/>
    <alias field="bridge" index="11" name=""/>
    <alias field="boundary" index="12" name=""/>
    <alias field="building" index="13" name=""/>
    <alias field="construction" index="14" name=""/>
    <alias field="covered" index="15" name=""/>
    <alias field="foot" index="16" name=""/>
    <alias field="highway" index="17" name=""/>
    <alias field="historic" index="18" name=""/>
    <alias field="horse" index="19" name=""/>
    <alias field="junction" index="20" name=""/>
    <alias field="landuse" index="21" name=""/>
    <alias field="layer" index="22" name=""/>
    <alias field="leisure" index="23" name=""/>
    <alias field="lock" index="24" name=""/>
    <alias field="man_made" index="25" name=""/>
    <alias field="military" index="26" name=""/>
    <alias field="name" index="27" name=""/>
    <alias field="natural" index="28" name=""/>
    <alias field="oneway" index="29" name=""/>
    <alias field="place" index="30" name=""/>
    <alias field="power" index="31" name=""/>
    <alias field="railway" index="32" name=""/>
    <alias field="ref" index="33" name=""/>
    <alias field="religion" index="34" name=""/>
    <alias field="route" index="35" name=""/>
    <alias field="service" index="36" name=""/>
    <alias field="shop" index="37" name=""/>
    <alias field="surface" index="38" name=""/>
    <alias field="tourism" index="39" name=""/>
    <alias field="tracktype" index="40" name=""/>
    <alias field="tunnel" index="41" name=""/>
    <alias field="water" index="42" name=""/>
    <alias field="waterway" index="43" name=""/>
    <alias field="way_area" index="44" name=""/>
    <alias field="z_order" index="45" name=""/>
    <alias field="tags" index="46" name=""/>
  </aliases>
