...
<qgis version="2.18.22" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="koord_ori">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="koord_gen">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="laenge_ori">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="laenge_gen">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  ...
  <aliases>
    ...
    <alias field="koord_ori" index="4" name=""/>
    <alias field="koord_gen" index="5" name=""/>
    <alias field="laenge_ori" index="6" name=""/>
    <alias field="laenge_gen" index="7" name=""/>
    <alias field="stand" index="8" name=""/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="koord_ori"/>
      <column width="-1" hidden="0" type="field" name="koord_gen"/>
      <column width="-1" hidden="0" type="field" name="laenge_ori"/>
      <column width="-1" hidden="0" type="field" name="laenge_gen"/>
    </columns>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="koord_ori" expression=""/>
    <default field="koord_gen" expression=""/>
    <default field="laenge_ori" expression=""/>
    <default field="laenge_gen" expression=""/>
